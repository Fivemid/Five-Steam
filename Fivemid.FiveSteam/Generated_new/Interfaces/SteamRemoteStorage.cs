...
namespace Fivemid.FiveSteam
{
    public unsafe static class SteamRemoteStorage
    {
        ...
        /// 
        /// <br />
        /// Creates a new file, writes the bytes to the file, and then closes the file. If the target file
        /// already exists, it is overwritten.<br />
        /// <br />
        /// <b>NOTE:</b> This is a synchronous call and as such is a will block your calling thread on
        /// the disk IO, and will also block the SteamAPI, which can cause other threads in your application to
        /// block. To avoid "hitching" due to a busy disk on the client machine using
        /// <a href="https://partner.steamgames.com/doc/api/ISteamRemoteStorage#FileWriteAsync" class="bb_apilink">ISteamRemoteStorage::FileWriteAsync</a>, the asynchronous version of this API is recommended.<br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        ...
        /// <ul class="bb_ul">
        ///     <li>
        ///         The file you're trying to write is larger than 100MiB as defined by
        ///         <a href="https://partner.steamgames.com/doc/api/ISteamRemoteStorage#k_unMaxCloudFileChunkSize" class="bb_apilink">k_unMaxCloudFileChunkSize</a>.<br />
        ///     </li>
        ///     <li>
        ///         <code class="bb_code bb_code_inline nohighlight">cubData</code> is less than
        ///         <strong>0</strong>.<br />
        ///     </li>
        ///     <li>
        ///         <code class="bb_code bb_code_inline nohighlight">pvData</code> is
        ///         <strong>NULL</strong>.<br />
        ///     </li>
        ///     <li>
        ///         You tried to write to an invalid path or filename. Because Steam Cloud is cross platform the
        ///         files need to have valid names on all supported OSes and file systems. See Microsoft's
        ///         documentation on
        ///         <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa365247(v=vs.85).aspx" target="_blank" rel="noreferrer">Naming Files, Paths, and Namespaces</a>.<br />
        ///     </li>
        ///     <li>
        ///         The current user's Steam Cloud storage quota has been exceeded. They may have run out of
        ///         space, or have too many files.<br />
        ///     </li>
        ///     <li>Steam could not write to the disk, the location might be read-only.</li>
        /// </ul>
        /// </summary>
        ...
        /// the disk IO, and will also block the SteamAPI, which can cause other threads in your application to
        /// block. To avoid "hitching" due to a busy disk on the client machine using
        /// <a href="https://partner.steamgames.com/doc/api/ISteamRemoteStorage#FileReadAsync" class="bb_apilink">ISteamRemoteStorage::FileReadAsync</a>, the asynchronous version of this API is recommended.<br />
        /// <br />
        /// <b>Returns:</b>
        /// <a href="https://partner.steamgames.com/doc/api/steam_api#int32" class="bb_apilink">int32</a><br />
        /// The number of bytes read.<br />
        /// <br />
        /// Returns <b>0</b> if the file doesn't exist or the read fails.
        /// </summary>
        ...
        ///             or
        ///             <a href="https://partner.steamgames.com/doc/api/ISteamRemoteStorage#GetFileTimestamp" class="bb_apilink">ISteamRemoteStorage::GetFileTimestamp</a>.
        ///         </param>
        ...
        /// 
        /// <br />
        /// Creates a new file and asynchronously writes the raw byte data to the Steam Cloud, and then closes
        /// the file. If the target file already exists, it is overwritten.<br />
        /// <br />
        /// <b>Returns:</b>
        /// <a href="https://partner.steamgames.com/doc/api/steam_api#SteamAPICall_t" class="bb_apilink">SteamAPICall_t</a>
        /// to be used with a
        /// <a href="https://partner.steamgames.com/doc/api/ISteamRemoteStorage#RemoteStorageFileWriteAsyncComplete_t" class="bb_apilink">RemoteStorageFileWriteAsyncComplete_t</a>
        /// call result.<br />
        /// Returns
        ...
        /// <a href="https://partner.steamgames.com/doc/api/ISteamRemoteStorage#GetFileSize" class="bb_apilink">ISteamRemoteStorage::GetFileSize</a>
        /// or
        /// <a href="https://partner.steamgames.com/doc/api/ISteamRemoteStorage#GetFileTimestamp" class="bb_apilink">ISteamRemoteStorage::GetFileTimestamp</a>.<br />
        /// <br />
        /// <b>Returns:</b>
        /// <a href="https://partner.steamgames.com/doc/api/steam_api#SteamAPICall_t" class="bb_apilink">SteamAPICall_t</a>
        /// to be used with a
        ...
        /// <ul class="bb_ul">
        ///     <li>
        ///         You tried to read from invalid path or filename. Because Steam Cloud is cross platform the
        ///         files need to have valid names on all supported OSes and file systems. See Microsoft's
        ///         documentation on
        ///         <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa365247(v=vs.85).aspx" target="_blank" rel="noreferrer">Naming Files, Paths, and Namespaces</a>.<br />
        ///     </li>
        ///     <li>The file doesn't exist.<br /></li>
        ///     <li>
        ///         <code class="bb_code bb_code_inline nohighlight">cubDataToRead</code> is &lt;= 0 bytes. You
        ///         need to be able to read something!<br />
        ///     </li>
        ///     <li>
        ///         The combination of <code class="bb_code bb_code_inline nohighlight">pvData</code> and
        ///         <code class="bb_code bb_code_inline nohighlight">cubDataToRead</code> would read past the
        ///         end of the file.<br />
        ///     </li>
        ///     <li>You have an async read in progress on this file already.</li>
        /// </ul>
        /// <br />
        /// Upon completion of the read request you will receive the call result, if the value of
        /// <code class="bb_code bb_code_inline nohighlight">m_eResult</code> within the call result is
        /// <a href="https://partner.steamgames.com/doc/api/steam_api#k_EResultOK" class="bb_apilink">k_EResultOK</a>
        /// you can then call
        /// <a href="https://partner.steamgames.com/doc/api/ISteamRemoteStorage#FileReadAsyncComplete" class="bb_apilink">ISteamRemoteStorage::FileReadAsyncComplete</a>
        /// to read the requested data into your buffer. The
        /// <code class="bb_code bb_code_inline nohighlight">hReadCall</code> parameter should match the return
        /// value of this function, and the amount to read should generally be equal to the amount requested as
        /// indicated by <code class="bb_code bb_code_inline nohighlight">m_nOffset</code> and
        ...
        /// <a href="https://partner.steamgames.com/doc/api/ISteamRemoteStorage#FileReadAsync" class="bb_apilink">ISteamRemoteStorage::FileReadAsync</a>
        ...
        /// <ul class="bb_ul">
        ///     <li>
        ///         The handle passed to <code class="bb_code bb_code_inline nohighlight">hReadCall</code> is
        ///         invalid.<br />
        ///     </li>
        ///     <li>
        ///         The read failed as indicated by
        ///         <code class="bb_code bb_code_inline nohighlight">m_eResult</code> in
        ///         <a href="https://partner.steamgames.com/doc/api/ISteamRemoteStorage#RemoteStorageFileReadAsyncComplete_t" class="bb_apilink">RemoteStorageFileReadAsyncComplete_t</a>, you shouldn't have called this.<br />
        ///     </li>
        ///     <li>
        ///         The buffer provided to
        ///         <code class="bb_code bb_code_inline nohighlight">pvBuffer</code> isn't big enough.
        ///     </li>
        /// </ul>
        /// </summary>
        ...
        /// <summary>
        /// <code>bool FileForget( const char *pchFile );</code>
        /// 
        /// <br />
        /// Deletes the file from remote storage, but leaves it on the local disk and remains accessible from
        /// the API.<br />
        /// <br />
        /// When you are out of Cloud space, this can be used to allow calls to
        /// <a href="https://partner.steamgames.com/doc/api/ISteamRemoteStorage#FileWrite" class="bb_apilink">ISteamRemoteStorage::FileWrite</a>
        /// to keep working without needing to make the user delete files.<br />
        /// <br />
        /// How you decide which files to forget are up to you. It could be a simple Least Recently Used (LRU)
        /// queue or something more complicated.<br />
        /// <br />
        /// Requiring the user to manage their Cloud-ized files for a game, while is possible to do, it is never
        /// recommended. For instance, "Which file would you like to delete so that you may store this new one?"
        /// removes a significant advantage of using the Cloud in the first place: its transparency.<br />
        /// <br />
        /// Once a file has been deleted or forgotten, calling
        /// <a href="https://partner.steamgames.com/doc/api/ISteamRemoteStorage#FileWrite" class="bb_apilink">ISteamRemoteStorage::FileWrite</a>
        /// will resynchronize it in the Cloud. Rewriting a forgotten file is the only way to make it persisted
        /// again.<br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// <b>true</b> if the file exists and has been successfully forgotten; otherwise,
        /// <b>false</b>.
        /// </summary>
        ...
        /// <summary>
        /// <code>bool FileDelete( const char *pchFile );</code>
        /// 
        /// <br />
        ...
        /// <a href="https://partner.steamgames.com/doc/api/ISteamRemoteStorage#FileForget" class="bb_apilink">ISteamRemoteStorage::FileForget</a>
        /// if you want to remove a file from the Steam Cloud but retain it on the users local disk.<br />
        /// <br />
        /// When a file has been deleted it can be re-written with
        /// <a href="https://partner.steamgames.com/doc/api/ISteamRemoteStorage#FileWrite" class="bb_apilink">ISteamRemoteStorage::FileWrite</a>
        /// to reupload it to the Steam Cloud.<br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// <b>true</b> if the file exists and has been successfully deleted; otherwise,
        /// <b>false</b> if the file did not exist.
        /// </summary>
        ...
        /// <summary>
        /// <code>SteamAPICall_t FileShare( const char *pchFile );</code>
        /// 
        /// <br />
        /// <b>Returns:</b>
        /// <a href="https://partner.steamgames.com/doc/api/steam_api#SteamAPICall_t" class="bb_apilink">SteamAPICall_t</a>
        /// to be used with a
        /// <a href="https://partner.steamgames.com/doc/api/ISteamRemoteStorage#RemoteStorageFileShareResult_t" class="bb_apilink">RemoteStorageFileShareResult_t</a>
        /// call result.
        /// </summary>
        ...
        /// <br />
        /// Files default to
        /// <a href="https://partner.steamgames.com/doc/api/ISteamRemoteStorage#k_ERemoteStoragePlatformAll" class="bb_apilink">k_ERemoteStoragePlatformAll</a>
        /// when they are first created. You can use the bitwise OR operator, "|" to specify multiple
        /// platforms.<br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        ...
        /// 
        /// <br />
        /// Creates a new file output stream allowing you to stream out data to the Steam Cloud file in chunks.
        /// If the target file already exists, it is not overwritten until
        /// <a href="https://partner.steamgames.com/doc/api/ISteamRemoteStorage#FileWriteStreamClose" class="bb_apilink">ISteamRemoteStorage::FileWriteStreamClose</a>
        /// has been called.<br />
        /// <br />
        /// To write data out to this stream you can use
        /// <a href="https://partner.steamgames.com/doc/api/ISteamRemoteStorage#FileWriteStreamWriteChunk" class="bb_apilink">ISteamRemoteStorage::FileWriteStreamWriteChunk</a>, and then to close or cancel you use
        /// <a href="https://partner.steamgames.com/doc/api/ISteamRemoteStorage#FileWriteStreamClose" class="bb_apilink">ISteamRemoteStorage::FileWriteStreamClose</a>
        /// and
        /// <a href="https://partner.steamgames.com/doc/api/ISteamRemoteStorage#FileWriteStreamCancel" class="bb_apilink">ISteamRemoteStorage::FileWriteStreamCancel</a>
        /// respectively.<br />
        /// <br />
        /// <b>Returns:</b>
        /// <a href="https://partner.steamgames.com/doc/api/ISteamRemoteStorage#UGCFileWriteStreamHandle_t" class="bb_apilink">UGCFileWriteStreamHandle_t</a><br />
        /// Returns
        /// <a href="https://partner.steamgames.com/doc/api/ISteamRemoteStorage#k_UGCFileStreamHandleInvalid" class="bb_apilink">k_UGCFileStreamHandleInvalid</a>
        /// under the following conditions:<br />
        /// <ul class="bb_ul">
        ///     <li>
        ///         You tried to write to an invalid path or filename. Because Steam Cloud is cross platform the
        ...
        /// <summary>
        /// <code>
        ///     bool FileWriteStreamWriteChunk( UGCFileWriteStreamHandle_t writeHandle, const void *pvData,
        ///     int32 cubData );
        /// </code>
        /// 
        /// <br />
        ...
        /// a valid file write stream, <code class="bb_code bb_code_inline nohighlight">cubData</code> is
        ...
        /// <summary>
        /// <code>bool FileWriteStreamClose( UGCFileWriteStreamHandle_t writeHandle );</code>
        /// 
        /// <br />
        /// Closes a file write stream that was started by
        /// <a href="https://partner.steamgames.com/doc/api/ISteamRemoteStorage#FileWriteStreamOpen" class="bb_apilink">ISteamRemoteStorage::FileWriteStreamOpen</a>.<br />
        /// <br />
        /// This flushes the stream to the disk, overwriting the existing file if there was one.<br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// <b>true</b> if the file write stream was successfully closed, the file has been committed
        /// to the disk.<br />
        /// <b>false</b> if <code class="bb_code bb_code_inline nohighlight">writeHandle</code> is not
        ...
        /// <a href="https://partner.steamgames.com/doc/api/ISteamRemoteStorage#FileWriteStreamOpen" class="bb_apilink">ISteamRemoteStorage::FileWriteStreamOpen</a>.<br />
        /// <br />
        /// This trashes all of the data written and closes the write stream, but if there was an existing file
        /// with this name, it remains untouched.<br />
        /// <br />
        /// <b>Returns:</b> bool
        /// </summary>
        ...
        /// <summary>
        /// <code>bool FilePersisted( const char *pchFile );</code>
        /// 
        /// <br />
        ...
        /// <b>false</b> if
        /// <a href="https://partner.steamgames.com/doc/api/ISteamRemoteStorage#FileForget" class="bb_apilink">ISteamRemoteStorage::FileForget</a>
        /// was called on it and is only available locally.
        /// </summary>
        /// <param name="pchFile">const char *: The name of the file.</param>
        public static bool FilePersisted(UTF8StringPtr pchFile) => Instance.FilePersisted(pchFile);
        /// <summary>
        /// <code>int32 GetFileSize( const char *pchFile );</code>
        /// 
        /// <br />
        ...
        /// <b>Returns:</b>
        /// <a href="https://partner.steamgames.com/doc/api/steam_api#int32" class="bb_apilink">int32</a><br />
        /// The size of the file in bytes. Returns<b>0</b> if the file does not exist.
        /// </summary>
        /// <param name="pchFile">const char *: The name of the file.</param>
        public static int GetFileSize(UTF8StringPtr pchFile) => Instance.GetFileSize(pchFile);
        /// <summary>
        /// <code>int64 GetFileTimestamp( const char *pchFile );</code>
        /// 
        /// <br />
        /// Gets the specified file's last modified timestamp in Unix epoch format (seconds since Jan 1st
        /// 1970).<br />
        /// <br />
        /// <b>Returns:</b>
        /// <a href="https://partner.steamgames.com/doc/api/steam_api#int64" class="bb_apilink">int64</a><br />
        ...
        /// <summary>
        /// <code>ERemoteStoragePlatform GetSyncPlatforms( const char *pchFile );</code>
        /// 
        /// <br />
        /// Obtains the platforms that the specified file will syncronize to.<br />
        /// <br />
        /// <b>Returns:</b>
        /// <a href="https://partner.steamgames.com/doc/api/ISteamRemoteStorage#ERemoteStoragePlatform" class="bb_apilink">ERemoteStoragePlatform</a><br />
        /// Bitfield containing the platforms that the file was set to with
        ...
        /// <summary>
        /// <code>int32 GetFileCount();</code>
        /// Gets the total number of local files synchronized by Steam Cloud.<br />
        /// <br />
        /// Used for enumeration with
        /// <a href="https://partner.steamgames.com/doc/api/ISteamRemoteStorage#GetFileNameAndSize" class="bb_apilink">ISteamRemoteStorage::GetFileNameAndSize</a>.<br />
        /// <br />
        /// <b>Returns:</b>
        /// <a href="https://partner.steamgames.com/doc/api/steam_api#int32" class="bb_apilink">int32</a><br />
        ...
        /// first to get the number of files.<br />
        /// <br />
        /// <b>Returns:</b> const char *<br />
        /// The name of the file at the specified index, if it exists. Returns an empty string ("") if the file
        /// doesn't exist.<br />
        /// <br />
        /// <b>Example:</b><br />
        /// <code>
        ///     int32 fileCount = SteamRemoteStorage()-&gt;GetFileCount(); for ( int i = 0; i &lt; fileCount;
        ///     ++i ) { int32 fileSize; const char *fileName = SteamRemoteStorage()-&gt;GetFileNameAndSize( i,
        ///     &amp;fileSize ); // Do something with fileSize and fileName }
        /// </code>
        /// </summary>
        /// <param name="iFile">int: 
        ...
        /// Checks if the account wide Steam Cloud setting is enabled for this user; or if they disabled it in
        /// the Settings-&gt;Cloud dialog.<br />
        /// <br />
        /// Ensure that you are also checking
        /// <a href="https://partner.steamgames.com/doc/api/ISteamRemoteStorage#IsCloudEnabledForApp" class="bb_apilink">ISteamRemoteStorage::IsCloudEnabledForApp</a>, as these two options are mutually exclusive.<br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// <b>true</b> if Steam Cloud is enabled for this account; otherwise, <b>false</b>.
        /// </summary>
        /// 
        public static bool IsCloudEnabledForAccount() => Instance.IsCloudEnabledForAccount();
        /// <summary>
        /// <code>bool IsCloudEnabledForApp();</code>
        /// Checks if the per game Steam Cloud setting is enabled for this user; or if they disabled it in the
        /// Game Properties-&gt;Update dialog.<br />
        /// <br />
        /// Ensure that you are also checking
        /// <a href="https://partner.steamgames.com/doc/api/ISteamRemoteStorage#IsCloudEnabledForAccount" class="bb_apilink">ISteamRemoteStorage::IsCloudEnabledForAccount</a>, as these two options are mutually exclusive.<br />
        /// <br />
        /// It's generally recommended that you allow the user to toggle this setting within your in-game
        /// options, you can toggle it with
        /// <a href="https://partner.steamgames.com/doc/api/ISteamRemoteStorage#SetCloudEnabledForApp" class="bb_apilink">ISteamRemoteStorage::SetCloudEnabledForApp</a>.<br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// <b>true</b> if Steam Cloud is enabled for this app; otherwise, <b>false</b>.
        /// </summary>
        /// 
        public static bool IsCloudEnabledForApp() => Instance.IsCloudEnabledForApp();
        /// <summary>
        /// <code>void SetCloudEnabledForApp( bool bEnabled );</code>
        /// 
        /// <br />
        /// Toggles whether the Steam Cloud is enabled for your application.<br />
        /// <br />
        /// This setting can be queried with
        /// <a href="https://partner.steamgames.com/doc/api/ISteamRemoteStorage#IsCloudEnabledForApp" class="bb_apilink">ISteamRemoteStorage::IsCloudEnabledForApp</a>.<br />
        /// <br />
        /// <b>NOTE:</b> This must only ever be called as the direct result of the user explicitly
        /// requesting that it's enabled or not. This is typically accomplished with a checkbox within your
        /// in-game options.
        /// </summary>
        /// <param name="bEnabled">bool: 
        ///             Enable (<b>true</b>) or disable (<b>false</b>) the Steam Cloud for
        ///             this application?
        ///         </param>
        ...
        /// <summary>
        /// <code>
        ///     bool GetUGCDownloadProgress( UGCHandle_t hContent, int32 *pnBytesDownloaded, int32
        ///     *pnBytesExpected );
        /// </code>
        /// 
        /// <br />
        ...
        /// <summary>
        /// <code>
        ///     bool GetUGCDetails( UGCHandle_t hContent, AppId_t *pnAppID, char **ppchName, int32
        ///     *pnFileSizeInBytes, CSteamID *pSteamIDOwner );
        /// </code>
        /// 
        /// <br />
        /// <b>Returns:</b> bool
        ...
        /// <summary>
        /// <code>UGCHandle_t GetCachedUGCHandle( int32 iCachedContent );</code>
        /// 
        /// <br />
        /// <b>Returns:</b>
        ...
        /// <summary>
        /// <code>
        ///     SteamAPICall_t PublishWorkshopFile( const char *pchFile, const char *pchPreviewFile, AppId_t
        ///     nConsumerAppId, const char *pchTitle, const char *pchDescription,
        ...
        /// <summary>
        /// <code>
        ///     PublishedFileUpdateHandle_t CreatePublishedFileUpdateRequest( PublishedFileId_t
        ///     unPublishedFileId );
        /// </code>
        /// 
        /// <br />
        ...
        /// <summary>
        /// <code>
        ///     bool UpdatePublishedFilePreviewFile( PublishedFileUpdateHandle_t updateHandle, const char
        ///     *pchPreviewFile );
        /// </code>
        /// 
        /// <br />
        ...
        /// <summary>
        /// <code>
        ///     bool UpdatePublishedFileDescription( PublishedFileUpdateHandle_t updateHandle, const char
        ///     *pchDescription );
        /// </code>
        /// 
        /// <br />
        ...
        /// <summary>
        /// <code>
        ///     bool UpdatePublishedFileTags( PublishedFileUpdateHandle_t updateHandle, SteamParamStringArray_t
        ///     *pTags );
        /// </code>
        /// 
        /// <br />
        ...
        /// <summary>
        /// <code>
        ///     bool UpdatePublishedFileSetChangeDescription( PublishedFileUpdateHandle_t updateHandle, const
        ///     char *pchChangeDescription );
        /// </code>
        /// 
        /// <br />
        /// Deprecated - Only used with the deprecated RemoteStorage based Workshop API.<br />
        ...
        /// <summary>
        /// <code>
        ///     SteamAPICall_t EnumerateUserSharedWorkshopFiles( CSteamID steamId, uint32 unStartIndex,
        ...
        /// <summary>
        /// <code>
        ///     SteamAPICall_t PublishVideo( EWorkshopVideoProvider eVideoProvider, const char *pchVideoAccount,
        ///     const char *pchVideoIdentifier, const char *pchPreviewFile, AppId_t nConsumerAppId, const char
        ///     *pchTitle, const char *pchDescription, ERemoteStoragePublishedFileVisibility eVisibility,
        ...
        /// <summary>
        /// <code>
        ///     SteamAPICall_t EnumeratePublishedFilesByUserAction( EWorkshopFileAction eAction, uint32
        ///     unStartIndex );
        /// </code>
        /// 
        /// <br />
        ...
        /// <summary>
        /// <code>
        ///     SteamAPICall_t UGCDownloadToLocation( UGCHandle_t hContent, const char *pchLocation, uint32
        ///     unPriority );
        /// </code>
        /// 
        /// <br />
        ...
        /// <a href="https://partner.steamgames.com/doc/api/ISteamRemoteStorage#RemoteStorageLocalFileChange_t" class="bb_apilink">ISteamRemoteStorage::RemoteStorageLocalFileChange_t</a>, use this method to get the number of changes (file updates and file deletes) that have been made.
        /// You can then iterate the changes using
        ...
        /// <summary>
        /// <code>
        ///     const char *GetLocalFileChange( int iFile, ERemoteStorageLocalFileChange *pEChangeType,
        ...
        /// <br />
        /// After calling
        /// <a href="https://partner.steamgames.com/doc/api/ISteamRemoteStorage#GetLocalFileChangeCount" class="bb_apilink">ISteamRemoteStorage::GetLocalFileChangeCount</a>, use this method to iterate over the changes. The changes described have already been made to
        /// local files. Your application should take appropriate action to reload state from disk, and possibly
        /// notify the user. <br />
        /// <br />
        /// For example: The local system had been suspended, during which time the user played elsewhere and
        /// uploaded changes to the Steam Cloud. On resume, Steam downloads those changes to the local system
        /// before resuming the application. The application receives an
        /// <a href="https://partner.steamgames.com/doc/api/ISteamRemoteStorage#RemoteStorageLocalFileChange_t" class="bb_apilink">ISteamRemoteStorage::RemoteStorageLocalFileChange_t</a>, and uses
        ...
        /// to iterate those changes. Depending on the application structure and the nature of the changes, the
        /// application could:<br />
        /// <br />
        /// <ul class="bb_ul">
        ///     <li>
        ///         Re-load game progress to resume at exactly the point where the user was when they exited the
        ///         game on the other device<br />
        ///     </li>
        ///     <li>Notify the user of any synchronized changes that don't require reloading<br /></li>
        ///     <li>etc</li>
        /// </ul>
        /// <br />
        /// <br />
        ...
        /// <br />
        /// Use this along with
        /// <a href="https://partner.steamgames.com/doc/api/ISteamRemoteStorage#EndFileWriteBatch" class="bb_apilink">EndFileWriteBatch</a>
        /// to wrap a set of local file writes/deletes that should be considered part of one single state
        /// change. For example, if saving game progress requires updating both
        /// <code class="bb_code bb_code_inline nohighlight">savegame1.dat</code> and
        /// <code class="bb_code bb_code_inline nohighlight">maxprogress.dat</code>, wrap those operations with
        /// calls to <code class="bb_code bb_code_inline nohighlight">BeginFileWriteBatch</code> and
        /// <code class="bb_code bb_code_inline nohighlight">EndFileWriteBatch</code>.<br />
        /// <br />
        /// These functions provide a hint to Steam which will help it manage the app's Cloud files. Using these
        /// functions is optional, however it will provide better reliability.<br />
        /// <br />
        /// Note that the functions may be used whether the writes are done using the
        /// <code class="bb_code bb_code_inline nohighlight">ISteamRemoteStorage</code> API, or done directly to
        /// local disk (where AutoCloud is used). <br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// <b>true</b> if the write batch was begun, <b>false</b> if there was a batch
        /// already in progress.
        /// </summary>
        /// 
        public static bool BeginFileWriteBatch() => Instance.BeginFileWriteBatch();
        /// <summary>
        /// <code>bool EndFileWriteBatch( );</code>
        /// <br />
        /// Use this along with
        /// <a href="https://partner.steamgames.com/doc/api/ISteamRemoteStorage#BeginFileWriteBatch" class="bb_apilink">BeginFileWriteBatch</a>
        /// - see that documentation for more details.<br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// <b>true</b> if the write batch was ended, <b>false</b> if there was no batch
        /// already in progress.
        /// </summary>
        /// 
