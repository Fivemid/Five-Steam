...
{
    public unsafe static class SteamGameServerNetworkingSockets_SteamAPI
    {
        ...
        /// <a href="https://partner.steamgames.com/doc/api/ISteamNetworkingSockets#ConnectByIPAddress" class="bb_apilink">ISteamNetworkingSockets::ConnectByIPAddress</a>, over ordinary UDP (IPv4 or IPv6)<br />
        /// <br />
        /// You must select a specific local port to listen on and set it as the port field of the local
        /// address.<br />
        /// <br />
        /// Usually you will set the IP portion of the address to zero, (<a href="https://partner.steamgames.com/doc/api/steamnetworkingtypes#SteamNetworkingIPAddr" class="bb_apilink">SteamNetworkingIPAddr</a>::Clear()). This means that you will not bind to any particular local interface (i.e. the same as
        ...
        /// <a href="https://partner.steamgames.com/doc/api/steamnetworkingtypes#SteamNetworkingConfigValue_t" class="bb_apilink">SteamNetworkingConfigValue_t</a>
        ...
        /// <a href="https://partner.steamgames.com/doc/api/ISteamNetworkingSockets#SteamNetConnectionStatusChangedCallback_t" class="bb_apilink">SteamNetConnectionStatusChangedCallback_t</a>
        ...
        /// <a href="https://partner.steamgames.com/doc/api/ISteamnetworkingSockets#CreateListenSocketIP" class="bb_apilink">ISteamnetworkingSockets::CreateListenSocketIP</a>
        ...
        /// <a href="https://partner.steamgames.com/doc/api/ISteamNetworkingSockets#SteamNetConnectionStatusChangedCallback_t" class="bb_apilink">SteamNetConnectionStatusChangedCallback_t</a>.) It's up to your application to decide whether to allow the connection.<br />
        /// <br />
        /// If you need to set any initial config options, pass them here. See
        /// <a href="https://partner.steamgames.com/doc/api/steamnetworkingtypes#SteamNetworkingConfigValue_t" class="bb_apilink">SteamNetworkingConfigValue_t</a>
        ...
        /// <br />
        /// Like
        /// <a href="https://partner.steamgames.com/doc/api/ISteamNetworkingSockets#CreateListenSocketIP" class="bb_apilink">ISteamNetworkingSockets::CreateListenSocketIP</a>, but clients will connect using
        /// <a href="https://partner.steamgames.com/doc/api/ISteamNetworkingSockets#ConnectP2P" class="bb_apilink">ISteamNetworkingSockets::ConnectP2P</a>. The connection will be relayed through the Valve network.<br />
        /// <br />
        /// nLocalVirtualPort specifies how clients can connect to this socket using
        /// <a href="https://partner.steamgames.com/doc/api/ConnectP2P" class="bb_apilink">ConnectP2P</a>. It's
        /// very common for applications to only have one listening socket; in that case, use zero. If you need
        /// to open multiple listen sockets and have clients be able to connect to one or the other, then
        /// nLocalVirtualPort should be a small integer (&lt;1000) unique to each listen socket you create.<br />
        /// <br />
        /// If you are listening on a dedicated servers in known data center, then you can listen using this
        /// function instead of
        /// <a href="https://partner.steamgames.com/doc/api/CreateHostedDedicatedServerListenSocket" class="bb_apilink">CreateHostedDedicatedServerListenSocket</a>, to allow clients to connect without a ticket. Any user that owns the app and is signed into Steam
        ...
        /// <a href="https://partner.steamgames.com/doc/api/ISteamNetworkingUtils#InitRelayNetworkAccess" class="bb_apilink">ISteamNetworkingUtils::InitRelayNetworkAccess</a>
        ...
        /// <summary>
        /// <code>EResult AcceptConnection( HSteamNetConnection hConn );</code>
        /// <br />
        ...
        /// receiving communication from the client, the connection attempt will<br />
        /// be timed out locally, transitioning the connection to the
        /// k_ESteamNetworkingConnectionState_ProblemDetectedLocally state. The client may also close the
        /// connection before it is accepted, and a transition to the
        ...
        /// <a href="https://partner.steamgames.com/doc/api/steamnetworkingtypes#ESteamNetConnectionEnd" class="bb_apilink">ESteamNetConnectionEnd</a>.) If you don't need to communicate any information to the remote host, and do not want analytics
        /// to be able to distinguish "normal" connection terminations from "exceptional" ones, you may pass
        /// zero, in which case the generic value of k_ESteamNetConnectionEnd_App_Generic will be used.<br />
        /// <br />
        ...
        /// <summary>
        /// <code>bool CloseListenSocket( HSteamListenSocket hSocket );</code>
        /// <br />
        ...
        ///         <a href="https://partner.steamgames.com/doc/api/ISteamNetworkingSockets#GetConnectionUserData" class="bb_apilink">ISteamNetworkingSockets::GetConnectionUserData</a>.<br />
        ///     </li>
        ///     <li>
        ///         The
        ///         <a href="https://partner.steamgames.com/doc/api/steamnetworkingtypes#SteamNetworkingMessage_t" class="bb_apilink">SteamNetworkingMessage_t</a>
        ///         structure.<br />
        ///     </li>
        ///     <li>
        ///         The
        ///         <a href="https://partner.steamgames.com/doc/api/steamnetworkingtypes#SteamNetConnectionInfo_t" class="bb_apilink">SteamNetConnectionInfo_t</a>
        ...
        /// the callback was queued. There are subtle race conditions that can happen if you<br />
        ...
        /// <summary>
        /// <code>int64 GetConnectionUserData( HSteamNetConnection hPeer );</code>
        ...
        /// <a href="https://partner.steamgames.com/doc/api/ISteamNetworkingUtils#AllocateMessage" class="bb_apilink">ISteamNetworkingUtils::AllocateMessage</a>. (Do not declare one on the stack or allocate your own.)<br />
        /// <br />
        ...
        /// <a href="https://partner.steamgames.com/doc/api/ISteamNetworkingSockets#SendMessageToConnection" class="bb_apilink">ISteamNetworkingSockets::SendMessageToConnection</a>
        ...
        /// <summary>
        /// <code>EResult FlushMessagesOnConnection( HSteamNetConnection hConn );</code>
        ...
        /// <a href="https://partner.steamgames.com/doc/api/steamnetworkingtypes#SteamNetworkingMessage_t" class="bb_apilink">SteamNetworkingMessage_t</a>::Release() to each of them free up resources after you are done. It is safe to keep the object
        ...
        /// Try
        /// <a href="https://partner.steamgames.com/doc/api/ISteamGameServer#GetPublicIP" class="bb_apilink">ISteamGameServer::GetPublicIP</a>.<br />
        /// <br />
        ...
        /// <summary>
        /// <code>bool GetIdentity( SteamNetworkingIdentity *pIdentity );</code>
        ...
        /// <summary>
        /// <code>ESteamNetworkingAvailability InitAuthentication();</code>
        /// <br />
        ...
        /// <br />
        /// You can use
        /// <a href="https://partner.steamgames.com/doc/api/ISteamNetworkingSockets#GetAuthenticationStatus" class="bb_apilink">ISteamNetworkingSockets::GetAuthenticationStatus</a>
        /// or listen for
        /// <a href="https://partner.steamgames.com/doc/api/ISteamNetworkingSockets#SteamNetAuthenticationStatus_t" class="bb_apilink">SteamNetAuthenticationStatus_t</a>
        ...
        /// <summary>
        /// <code>HSteamNetPollGroup CreatePollGroup()</code>
        /// Create a new poll group.<br />
        /// <br />
        /// You should destroy the poll group when you are done using
        /// <a href="https://partner.steamgames.com/doc/api/ISteamNetworkingSockets#DestroyPollGroup" class="bb_apilink">ISteamNetworkingSockets::DestroyPollGroup</a>.
        /// </summary>
        /// 
        public static HSteamNetPollGroup CreatePollGroup() => Instance.CreatePollGroup();
        /// <summary>
        /// <code>bool DestroyPollGroup( HSteamNetPollGroup hPollGroup )</code>
        /// Destroy a poll group created with
        /// <a href="https://partner.steamgames.com/doc/api/ISteamNetworkingSockets#CreatePollGroup" class="bb_apilink">ISteamNetworkingSockets::CreatePollGroup</a>.<br />
        /// <br />
        ...
        /// <br />
        /// Same as
        /// <a href="https://partner.steamgames.com/doc/api/ISteamNetworkingSockets#ReceiveMessagesOnConnection" class="bb_apilink">ISteamNetworkingSockets::ReceiveMessagesOnConnection</a>, but will return the next messages available on any connection in the poll group. Examine
        ...
        /// <a href="https://partner.steamgames.com/doc/api/ISteamNetworkingSockets#ReceiveMessagesOnConnection" class="bb_apilink">ISteamNetworkingSockets::ReceiveMessagesOnConnection</a>. (But the messages are not grouped by connection, so they will not necessarily appear
        ...
        /// mode, use
        /// <a href="https://partner.steamgames.com/doc/api/ConnectP2P" class="bb_apilink">ConnectP2P</a>. (The
        /// server must be configured to allow this type of connection by listening using
        /// <a href="https://partner.steamgames.com/doc/api/CreateListenSocketP2P" class="bb_apilink">CreateListenSocketP2P</a>.)<br />
        /// <br />
        ...
        /// <summary>
        /// <code>uint16 GetHostedDedicatedServerPort();</code>
        ...
        /// <summary>
        /// <code>SteamNetworkingPOPID GetHostedDedicatedServerPOPID();</code>
        ...
        /// <a href="https://partner.steamgames.com/doc/api/steamnetworkingtypes#SteamDatagramRelayAuthTicket" class="bb_apilink">SteamDatagramRelayAuthTicket</a>
        /// for more info.<br />
        /// <br />
        /// Also, note that the routing information is contained in
        /// <a href="https://partner.steamgames.com/doc/api/steamnetworkingtypes#SteamDatagramGameCoordinatorServerLogin" class="bb_apilink">SteamDatagramGameCoordinatorServerLogin</a>, so if possible, it's preferred to use
        /// <a href="https://partner.steamgames.com/doc/api/SteamNetworkingSockets#GetGameCoordinatorServerLogin" class="bb_apilink">SteamNetworkingSockets::GetGameCoordinatorServerLogin</a>
        ...
        ///         <a href="https://partner.steamgames.com/doc/api/ISteamNetworkingSockets#GetAuthenticationStatus" class="bb_apilink">ISteamNetworkingSockets::GetAuthenticationStatus</a>.) If you use environment variables to pre-fetch the network config, this data should
        ...
        /// connect using
        /// <a href="https://partner.steamgames.com/doc/api/ConnectToHostedDedicatedServer" class="bb_apilink">ConnectToHostedDedicatedServer</a>.<br />
        /// <br />
        /// If you need to set any initial config options, pass them here. See
        /// <a href="https://partner.steamgames.com/doc/api/steamnetworkingtypes#SteamNetworkingConfigValue_t" class="bb_apilink">SteamNetworkingConfigValue_t</a>
        /// for more about why this is preferable to setting the options "immediately" after creation.
        ...
        ///     <li>
        ///         See
        ///         <a href="https://partner.steamgames.com/doc/api/ISteamNetwrokingSockets#GetHostedDedicatedServerAddress" class="bb_apilink">ISteamNetwrokingSockets::GetHostedDedicatedServerAddress</a>
        ...
        /// <a href="https://partner.steamgames.com/doc/api/steamnetwrokingtypes#SteamDatagramGameCoordinatorServerLogin" class="bb_apilink">SteamDatagramGameCoordinatorServerLogin</a>
        ...
        /// <summary>
        /// <code>bool BeginAsyncRequestFakeIP( int nNumPorts );</code>
        /// <br />
        ...
        /// <a href="https://partner.steamgames.com/doc/api/CreateFakeUDPPort" class="bb_apilink">CreateFakeUDPPort</a>.
        /// </summary>
        /// 
        ...
        /// <a href="https://partner.steamgames.com/doc/api/ConnectByIPAddress" class="bb_apilink">ConnectByIPAddress</a>.<br />
        /// <br />
        ...
        /// <a href="https://partner.steamgames.com/doc/api/BeginAsyncRequestFakeIP" class="bb_apilink">BeginAsyncRequestFakeIP</a>. However, you do not need to wait for the request to complete before creating the listen socket.
        /// </summary>
        /// 
        ...
        /// <a href="https://partner.steamgames.com/doc/api/BeginAsyncRequestFakeIP" class="bb_apilink">BeginAsyncRequestFakeIP</a>
        /// and is used to create "server" ports. You may call this before the allocation has completed.
        /// However, any attempts to send packets will fail until the allocation has succeeded. When the peer
        /// receives packets sent from this interface, the from address of the packet will be the
        /// globally-unique FakeIP. If you call this function multiple times and pass the same (nonnegative)
        /// fake port index, the same object will be returned, and this object is not reference counted.<br />
        /// <br />
