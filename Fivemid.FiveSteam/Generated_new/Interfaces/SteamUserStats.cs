...
namespace Fivemid.FiveSteam
{
    public unsafe static class SteamUserStats
    {
        ...
        /// <summary>
        /// <code>bool RequestCurrentStats();</code>
        /// Asynchronously request the user's current stats and achievements from the server.<br />
        /// <br />
        /// You must always call this first to get the initial status of stats and achievements.<br />
        /// Only after the resulting callback comes back can you start calling the rest of the stats and
        /// achievement functions for the current user.<br />
        /// <br />
        /// The equivalent function for other users is
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#RequestUserStats" class="bb_apilink">ISteamUserStats::RequestUserStats</a>.<br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// Triggers a
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#UserStatsReceived_t" class="bb_apilink">UserStatsReceived_t</a>
        /// callback.<br />
        /// Only returns <b>false</b> if there is no user logged in; otherwise,
        /// <b>true</b>.<br />
        /// <br />
        /// <b>See Also:</b>
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#GetStat" class="bb_apilink">ISteamUserStats::GetStat</a>,
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#SetStat" class="bb_apilink">ISteamUserStats::SetStat</a>,
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#SetAchievement" class="bb_apilink">ISteamUserStats::SetAchievement</a>,
        ...
        /// <summary>
        /// <code>
        ///     bool GetStat( const char *pchName, int32 *pData ); bool GetStat( const char *pchName, float
        ///     *pData );
        /// </code>
        /// 
        /// <br />
        ...
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#RequestCurrentStats" class="bb_apilink">ISteamUserStats::RequestCurrentStats</a>
        /// and it needs to return successfully via its callback prior to calling this.<br />
        /// <br />
        /// To receive stats for other users use
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#GetUserStat" class="bb_apilink">ISteamUserStats::GetUserStat</a>.<br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// This function returns <b>true</b> upon success if all of the following conditions are met;
        ...
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#RequestCurrentStats" class="bb_apilink">ISteamUserStats::RequestCurrentStats</a>,
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#SetStat" class="bb_apilink">ISteamUserStats::SetStat</a>,
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#UpdateAvgRateStat" class="bb_apilink">ISteamUserStats::UpdateAvgRateStat</a>,
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#StoreStats" class="bb_apilink">ISteamUserStats::StoreStats</a>,
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#ResetAllStats" class="bb_apilink">ISteamUserStats::ResetAllStats</a>
        /// </summary>
        ...
        /// and it needs to return successfully via its callback prior to calling this!<br />
        /// <br />
        /// This call only modifies Steam's in-memory state and is very cheap. Doing so allows Steam to persist
        /// the changes even in the event of a game crash or unexpected shutdown.<br />
        /// To submit the stats to the server you must call
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#StoreStats" class="bb_apilink">ISteamUserStats::StoreStats</a>.<br />
        /// <br />
        /// If this is returning false and everything appears correct, then check to ensure that your changes in
        /// the App Admin panel of the Steamworks website are published.<br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// This function returns <b>true</b> upon success if all of the following conditions are met;
        /// otherwise, <b>false</b>.<br />
        ...
        ///         has completed and successfully returned its callback.<br />
        ///     </li>
        ///     <li>The type must be AVGRATE in the Steamworks Partner backend.</li>
        /// </ul>
        /// </summary>
        /// <param name="pchName">const char *: 
        ///             The 'API Name' of the stat. Must not be longer than
        ...
        /// <summary>
        /// <code>bool GetAchievement( const char *pchName, bool *pbAchieved );</code>
        /// 
        /// <br />
        /// Gets the unlock status of the Achievement.<br />
        /// <br />
        /// The equivalent function for other users is
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#GetUserAchievement" class="bb_apilink">ISteamUserStats::GetUserAchievement</a>.<br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// This function returns <b>true</b> upon success if all of the following conditions are met;
        /// otherwise, <b>false</b>.<br />
        ...
        /// <code class="bb_code bb_code_inline nohighlight">pbAchieved</code> parameter.<br />
        /// <br />
        /// <b>See Also:</b>
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#GetAchievementDisplayAttribute" class="bb_apilink">ISteamUserStats::GetAchievementDisplayAttribute</a>,
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#GetAchievementName" class="bb_apilink">ISteamUserStats::GetAchievementName</a>,
        ...
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#GetAchievementAndUnlockTime" class="bb_apilink">ISteamUserStats::GetAchievementAndUnlockTime</a>,
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#GetAchievementAchievedPercent" class="bb_apilink">ISteamUserStats::GetAchievementAchievedPercent</a>
        /// </summary>
        ...
        /// <summary>
        /// <code>bool SetAchievement( const char *pchName );</code>
        /// 
        /// <br />
        ...
        /// and it needs to return successfully via its callback prior to calling this!<br />
        /// <br />
        /// You can unlock an achievement multiple times so you don't need to worry about only setting
        /// achievements that aren't already set. This call only modifies Steam's in-memory state so it is quite
        /// cheap. To send the unlock status to the server and to trigger the Steam overlay notification you
        /// must call
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#StoreStats" class="bb_apilink">ISteamUserStats::StoreStats</a>.<br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        ...
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#ResetAllStats" class="bb_apilink">ISteamUserStats::ResetAllStats</a>,
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#GetAchievementAndUnlockTime" class="bb_apilink">ISteamUserStats::GetAchievementAndUnlockTime</a>,
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#GetAchievement" class="bb_apilink">ISteamUserStats::GetAchievement</a>
        /// </summary>
        ...
        /// <summary>
        /// <code>bool ClearAchievement( const char *pchName );</code>
        /// 
        /// <br />
        ...
        /// and it needs to return successfully via its callback prior to calling this!<br />
        /// <br />
        /// This call only modifies Steam's in-memory state so it is quite cheap. To send the unlock status to
        /// the server and to trigger the Steam overlay notification you must call
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#StoreStats" class="bb_apilink">ISteamUserStats::StoreStats</a>.<br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// This function returns <b>true</b> upon success if all of the following conditions are met;
        ...
        /// began tracking achievement unlock times (December 2009). The time is provided in Unix epoch format,
        /// seconds since January 1, 1970 UTC.<br />
        /// <br />
        /// The equivalent function for other users is
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#GetUserAchievementAndUnlockTime" class="bb_apilink">ISteamUserStats::GetUserAchievementAndUnlockTime</a>.<br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// This function returns <b>true</b> upon success if all of the following conditions are met;
        /// otherwise, <b>false</b>.<br />
        ...
        /// <code class="bb_code bb_code_inline nohighlight">pbAchieved</code> and
        /// <code class="bb_code bb_code_inline nohighlight">punUnlockTime</code>.<br />
        /// <br />
        /// <b>See Also:</b>
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#GetAchievement" class="bb_apilink">ISteamUserStats::GetAchievement</a>,
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#GetAchievementDisplayAttribute" class="bb_apilink">ISteamUserStats::GetAchievementDisplayAttribute</a>,
        ...
        /// Send the changed stats and achievements data to the server for permanent storage.<br />
        /// <br />
        ...
        /// map changing, or the user leaving a server. This call is required to display the achievement unlock
        /// notification dialog though, so if you have called
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#SetAchievement" class="bb_apilink">ISteamUserStats::SetAchievement</a>
        /// then it's advisable to call this soon after that.<br />
        /// <br />
        ...
        /// <b>Returns:</b> bool<br />
        /// Triggers a
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#UserStatsStored_t" class="bb_apilink">UserStatsStored_t</a>
        /// callback.<br />
        /// Triggers a
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#UserAchievementStored_t" class="bb_apilink">UserAchievementStored_t</a>
        /// callback.<br />
        /// This function returns <b>true</b> upon success if all of the following conditions are met;
        /// otherwise, <b>false</b>.<br />
        /// <ul class="bb_ul">
        ...
        ///     </li>
        ///     <li>
        ///         The current game has stats associated with it in the Steamworks Partner backend, and those
        ///         stats are published.
        ///     </li>
        /// </ul>
        /// <br />
        ...
        /// <a href="https://partner.steamgames.com/doc/api/steam_api#k_EResultInvalidParam" class="bb_apilink">k_EResultInvalidParam</a>, then one or more stats uploaded has been rejected, either because they broke constraints or were
        /// out of date. In this case the server sends back updated values and the stats should be updated
        /// locally to keep in sync. You do not need to call RequestCurrentStats again in this case.<br />
        /// <br />
        ...
        /// <summary>
        /// <code>int GetAchievementIcon( const char *pchName );</code>
        /// 
        /// <br />
        ...
        /// <b>Returns:</b> int<br />
        /// Triggers a
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#UserAchievementIconFetched_t" class="bb_apilink">UserAchievementIconFetched_t</a>
        /// callback.<br />
        ...
        /// to get the actual image data.<br />
        /// <br />
        /// An invalid handle of <b>0</b> will be returned under the following conditions:<br />
        /// <ul class="bb_ul">
        ///     <li>
        ///         <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#RequestCurrentStats" class="bb_apilink">ISteamUserStats::RequestCurrentStats</a>
        ///         has not completed and successfully returned its callback.<br />
        ///     </li>
        ///     <li>
        ///         The specified achievement does not exist in App Admin on the Steamworks website, or the
        ///         changes are not published.<br />
        ///     </li>
        ///     <li>
        ///         Steam is still fetching the image data from the server. This will trigger a
        ///         <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#UserAchievementIconFetched_t" class="bb_apilink">UserAchievementIconFetched_t</a>
        ///         callback which will notify you when the image data is ready and provide you with a new
        ///         handle. If the <code class="bb_code bb_code_inline nohighlight">m_nIconHandle</code> in the
        ///         callback is still <strong>0</strong>, then there is no image set for the specified
        ///         achievement.
        ///     </li>
        /// </ul>
        /// <br />
        ...
        /// 
        /// <br />
        /// Get general attributes for an achievement. Currently provides: Name, Description, and Hidden
        /// status.<br />
        /// <br />
        /// This receives the value from a dictionary/map keyvalue store, so you must provide one of the
        /// following keys.<br />
        /// <ul class="bb_ul">
        ///     <li>"<strong>name</strong>" to retrive the localized achievement name in UTF8<br /></li>
        ///     <li>"<strong>desc</strong>" to retrive the localized achievement description in UTF8<br /></li>
        ///     <li>
        ///         "<strong>hidden</strong>" for retrieving if an achievement is hidden. Returns "0" when not
        ///         hidden, "1" when hidden
        ///     </li>
        /// </ul>
        /// <br />
        /// This localization is provided based on the games language if it's set, otherwise it checks if a
        /// localization is avilable for the users Steam UI Language. If that fails too, then it falls back to
        /// english.<br />
        /// <br />
        /// <b>Returns:</b> const char *<br />
        /// This function returns the value as a string upon success if all of the following conditions are met;
        /// otherwise, an empty string: <b>""</b>.<br />
        /// <ul class="bb_ul">
        ///     <li>
        ///         <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#RequestCurrentStats" class="bb_apilink">ISteamUserStats::RequestCurrentStats</a>
        ///         has completed and successfully returned its callback.<br />
        ///     </li>
        ///     <li>
        ///         The specified achievement exists in App Admin on the Steamworks website, and the changes are
        ///         published.<br />
        ///     </li>
        ///     <li>The specified <code class="bb_code bb_code_inline nohighlight">pchKey</code> is valid.</li>
        /// </ul>
        /// <br />
        /// <b>See Also:</b>
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#GetAchievement" class="bb_apilink">ISteamUserStats::GetAchievement</a>,
        ...
        /// <br />
        /// Calling this function will NOT set the progress or unlock the achievement, the game must do that
        /// manually by calling
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#SetStat" class="bb_apilink">ISteamUserStats::SetStat</a>!<br />
        /// <br />
        ...
        ///         published.<br />
        ///     </li>
        ///     <li>The specified achievement is not already unlocked.<br /></li>
        ///     <li>
        ///         <code class="bb_code bb_code_inline nohighlight">nCurProgress</code> is less than
        ///         <code class="bb_code bb_code_inline nohighlight">nMaxProgress</code>.
        ///     </li>
        /// </ul>
        /// <br />
        /// <b>See Also:</b>
        ...
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#SetStat" class="bb_apilink">ISteamUserStats::SetStat</a>,
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#StoreStats" class="bb_apilink">ISteamUserStats::StoreStats</a>,
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUtils#SetOverlayNotificationPosition" class="bb_apilink">ISteamUtils::SetOverlayNotificationPosition</a>,
        ...
        /// Get the number of achievements defined in the App Admin panel of the Steamworks website.<br />
        /// <br />
        /// This is used for iterating through all of the achievements with
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#GetAchievementName" class="bb_apilink">ISteamUserStats::GetAchievementName</a>.<br />
        /// <br />
        /// In general games should not need these functions because they should have a list of existing
        /// achievements compiled into them.<br />
        /// <br />
        /// <b>Returns:</b>
        /// <a href="https://partner.steamgames.com/doc/api/steam_api#uint32" class="bb_apilink">uint32</a><br />
        /// The number of achievements. Returns <b>0</b> if
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#RequestCurrentStats" class="bb_apilink">ISteamUserStats::RequestCurrentStats</a>
        /// has not been called and successfully returned its callback, or the current App ID has no
        /// achievements.<br />
        /// <br />
        /// <b>See Also:</b>
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#RequestCurrentStats" class="bb_apilink">ISteamUserStats::RequestCurrentStats</a>,
        ...
        /// <b>Example:</b><br />
        /// <code>
        ///     int numAchievements = SteamUserStats()-&gt;GetNumAchievements(); for ( int i = 0; i &lt;
        ///     numAchievements; ++i ) { const char *achName = SteamUserStats()-&gt;GetAchievementName( i ); if
        ...
        /// <summary>
        /// <code>const char * GetAchievementName( uint32 iAchievement );</code>
        /// 
        /// <br />
        /// Gets the 'API name' for an achievement index between 0 and
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#GetNumAchievements" class="bb_apilink">ISteamUserStats::GetNumAchievements</a>.<br />
        /// <br />
        /// This function must be used in cojunction with
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#GetNumAchievements" class="bb_apilink">ISteamUserStats::GetNumAchievements</a>
        /// to loop over the list of achievements.<br />
        /// <br />
        /// In general games should not need these functions as they should have the list of achievements
        /// compiled into them.<br />
        /// <br />
        /// <b>Returns:</b> const char *<br />
        /// The 'API Name' of the achievement, returns an empty string if
        /// <code class="bb_code bb_code_inline nohighlight">iAchievement</code> is not a valid index.
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#RequestCurrentStats" class="bb_apilink">ISteamUserStats::RequestCurrentStats</a>
        /// must have been called and successfully returned its callback, and the current App ID must have
        /// achievements.<br />
        /// <br />
        /// <b>Example:</b><br />
        /// <code>
        ...
        /// <br />
        /// These stats are not automatically updated; you'll need to call this function again to refresh any
        /// data that may have change.<br />
        /// <br />
        /// To keep from using too much memory, an least recently used cache (LRU) is maintained and other
        /// user's stats will occasionally be unloaded. When this happens a
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#UserStatsUnloaded_t" class="bb_apilink">UserStatsUnloaded_t</a>
        /// callback is sent. After receiving this callback the user's stats will be unavailable until this
        /// function is called again.<br />
        /// <br />
        /// The equivalent function for the local user is
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#RequestCurrentStats" class="bb_apilink">ISteamUserStats::RequestCurrentStats</a>, the equivalent function for game servers is
        /// <a href="https://partner.steamgames.com/doc/api/ISteamGameServerStats#RequestUserStats" class="bb_apilink">ISteamGameServerStats::RequestUserStats</a>.<br />
        /// <br />
        /// <b>Returns:</b>
        ...
        /// <br />
        /// The equivalent function for the local user is
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#GetStat" class="bb_apilink">ISteamUserStats::GetStat</a>, the equivalent function for game servers is
        /// <a href="https://partner.steamgames.com/doc/api/ISteamGameServerStats#GetUserStat" class="bb_apilink">ISteamGameServerStats::GetUserStat</a>.<br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// This function returns <b>true</b> upon success if all of the following conditions are met;
        /// otherwise, <b>false</b>.<br />
        ...
        /// <br />
        /// The equivalent function for the local user is
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#GetAchievement" class="bb_apilink">ISteamUserStats::GetAchievement</a>, the equivalent function for game servers is
        /// <a href="https://partner.steamgames.com/doc/api/ISteamGameServerStats#GetUserAchievement" class="bb_apilink">ISteamGameServerStats::GetUserAchievement</a>.<br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// This function returns <b>true</b> upon success if all of the following conditions are met;
        /// otherwise, <b>false</b>.<br />
        ...
        /// <summary>
        /// <code>
        ///     bool GetUserAchievementAndUnlockTime( CSteamID steamIDUser, const char *pchName, bool
        ///     *pbAchieved, uint32 *punUnlockTime );
        /// </code>
        /// 
        /// <br />
        /// Gets the achievement status, and the time it was unlocked if unlocked.<br />
        ...
        /// <br />
        /// The equivalent function for the local user is
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#GetAchievementAndUnlockTime" class="bb_apilink">ISteamUserStats::GetAchievementAndUnlockTime</a>.<br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// This function returns <b>true</b> upon success if all of the following conditions are met;
        /// otherwise, <b>false</b>.<br />
        ...
        /// development. Ensure that you sync up your stats with the new default values provided by Steam after
        ...
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// <b>true</b> indicating success if
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#RequestCurrentStats" class="bb_apilink">ISteamUserStats::RequestCurrentStats</a>
        /// has been called and successfully returned its callback; otherwise <b>false</b>.
        /// </summary>
        ...
        /// to obtain the leaderboard handle which is valid for the game session for each leaderboard you wish
        /// to access prior to calling any other Leaderboard functions.<br />
        /// <br />
        /// Leaderboards created with this function will not automatically show up in the Steam Community. You
        /// must manually set the Community Name field in the App Admin panel of the Steamworks website. As such
        /// it's generally recommended to prefer creating the leaderboards in the App Admin panel on the
        /// Steamworks website and using
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#FindLeaderboard" class="bb_apilink">ISteamUserStats::FindLeaderboard</a>
        /// unless you're expected to have a large amount of dynamically created leaderboards.<br />
        /// <br />
        /// You should never pass
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#k_ELeaderboardSortMethodNone" class="bb_apilink">k_ELeaderboardSortMethodNone</a>
        /// for <code class="bb_code bb_code_inline nohighlight">eLeaderboardSortMethod</code> or
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#k_ELeaderboardDisplayTypeNone" class="bb_apilink">k_ELeaderboardDisplayTypeNone</a>
        /// for <code class="bb_code bb_code_inline nohighlight">eLeaderboardDisplayType</code> as this is
        /// undefined behavior.<br />
        /// <br />
        /// <b>Returns:</b>
        /// <a href="https://partner.steamgames.com/doc/api/steam_api#SteamAPICall_t" class="bb_apilink">SteamAPICall_t</a>
        /// to be used with a
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#LeaderboardFindResult_t" class="bb_apilink">LeaderboardFindResult_t</a>
        /// call result.<br />
        /// <br />
        /// <br />
        /// <b>See Also:</b>
        ...
        /// </summary>
        /// <param name="pchLeaderboardName">const char *: 
        ...
        /// <summary>
        /// <code>SteamAPICall_t FindLeaderboard( const char *pchLeaderboardName );</code>
        /// 
        /// <br />
        ...
        /// </summary>
        /// <param name="pchLeaderboardName">const char *: 
        ///             The name of the leaderboard to find. Must not be longer than
        ///             <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#k_cchLeaderboardNameMax" class="bb_apilink">k_cchLeaderboardNameMax</a>.
        ///         </param>
        ...
        /// <summary>
        /// <code>int GetLeaderboardEntryCount( SteamLeaderboard_t hSteamLeaderboard );</code>
        /// 
        /// <br />
        ...
        /// or
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#FindOrCreateLeaderboard" class="bb_apilink">ISteamUserStats::FindOrCreateLeaderboard</a>
        /// and is refreshed on each successful call to
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#DownloadLeaderboardEntries" class="bb_apilink">ISteamUserStats::DownloadLeaderboardEntries</a>,
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#DownloadLeaderboardEntriesForUsers" class="bb_apilink">ISteamUserStats::DownloadLeaderboardEntriesForUsers</a>, and
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#UploadLeaderboardScore" class="bb_apilink">ISteamUserStats::UploadLeaderboardScore</a>.<br />
        /// <br />
        /// <b>Returns:</b> int<br />
        /// The number of entries in the leaderboard. Returns 0 if the leaderboard handle is invalid.<br />
        /// <br />
        /// <b>See Also:</b>
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#GetLeaderboardName" class="bb_apilink">ISteamUserStats::GetLeaderboardName</a>,
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#GetLeaderboardSortMethod" class="bb_apilink">ISteamUserStats::GetLeaderboardSortMethod</a>,
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#GetLeaderboardDisplayType" class="bb_apilink">ISteamUserStats::GetLeaderboardDisplayType</a>
        /// </summary>
        /// <param name="hSteamLeaderboard">SteamLeaderboard_t: 
        ...
        /// <br />
        /// <b>Returns:</b>
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#ELeaderboardSortMethod" class="bb_apilink">ELeaderboardSortMethod</a><br />
        /// The sort method of the leaderboard. Returns
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#k_ELeaderboardSortMethodNone" class="bb_apilink">k_ELeaderboardSortMethodNone</a>
        /// if the leaderboard handle is invalid.<br />
        /// <br />
        /// <b>See Also:</b>
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#GetLeaderboardName" class="bb_apilink">ISteamUserStats::GetLeaderboardName</a>,
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#GetLeaderboardDisplayType" class="bb_apilink">ISteamUserStats::GetLeaderboardDisplayType</a>,
        ...
        /// <br />
        /// <b>Returns:</b>
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#ELeaderboardDisplayType" class="bb_apilink">ELeaderboardDisplayType</a><br />
        /// The display type of the leaderboard. Returns
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#k_ELeaderboardDisplayTypeNone" class="bb_apilink">k_ELeaderboardDisplayTypeNone</a>
        /// if the leaderboard handle is invalid.<br />
        /// <br />
        /// <b>See Also:</b>
        ...
        /// <br />
        /// If you want to download entries for an arbitrary set of users, such as all of the users on a server
        /// then you can use
        ...
        /// which takes an array of Steam IDs.<br />
        /// <br />
        /// You must call
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#FindLeaderboard" class="bb_apilink">ISteamUserStats::FindLeaderboard</a>
        /// or
        ...
        /// <br />
        /// A maximum of 100 users can be downloaded at a time, with only one outstanding call at a time. If a
        /// user doesn't have an entry on the specified leaderboard, they won't be included in the result.<br />
        /// <br />
        /// If you want to download entries based on their ranking or friends of the current user then you
        /// should use
        ...
        /// indicating an error if the number of users is greater than 100 or if one of the Steam IDs is
        /// invalid.<br />
        /// <br />
        /// <b>See Also:</b>
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#GetDownloadedLeaderboardEntry" class="bb_apilink">ISteamUserStats::GetDownloadedLeaderboardEntry</a>,
        ...
        /// <summary>
        /// <code>
        ///     bool GetDownloadedLeaderboardEntry( SteamLeaderboardEntries_t hSteamLeaderboardEntries, int
        ///     index, LeaderboardEntry_t *pLeaderboardEntry, int32 *pDetails, int cDetailsMax );
        /// </code>
        /// 
        /// <br />
        ...
        /// to get all the downloaded entries. Once you've accessed all the entries, the data will be freed, and
        /// the
        ...
        /// handle will become invalid.<br />
        /// <br />
        /// Optionally details may be returned for the entry via the
        /// <code class="bb_code bb_code_inline nohighlight">pDetails</code>. If this is NULL then
        /// <code class="bb_code bb_code_inline nohighlight">cDetailsMax</code> MUST be
        /// <b>0</b>.<br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// This function returns <b>true</b> upon success if all of the following conditions are met;
        ...
        /// <ul class="bb_ul">
        ///     <li>
        ///         <code class="bb_code bb_code_inline nohighlight">hSteamLeaderboardEntries</code> must be a
        ///         valid handle from the last received
        ///         <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#LeaderboardScoresDownloaded_t" class="bb_apilink">LeaderboardScoresDownloaded_t</a>
        ///         call result.<br />
        ///     </li>
        ///     <li>
        ///         <code class="bb_code bb_code_inline nohighlight">index</code> must be between 0 and
        ///         <code class="bb_code bb_code_inline nohighlight">LeaderboardScoresDownloaded_t.m_cEntryCount</code>
        ///     </li>
        /// </ul>
        /// <br />
        /// If the call is successful then the entry is returned via the parameter
        /// <code class="bb_code bb_code_inline nohighlight">pLeaderboardEntry</code> and if
        /// <code class="bb_code bb_code_inline nohighlight">cDetailsMax</code> is not 0 then
        /// <code class="bb_code bb_code_inline nohighlight">pDetails</code> is filled with the unlock
        /// details.<br />
        /// <br />
        /// <b>See Also:</b>
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#DownloadLeaderboardEntries" class="bb_apilink">ISteamUserStats::DownloadLeaderboardEntries</a>,
        ...
        /// <b>Example:</b><br />
        /// <code>
        ///     void OnLeaderboardScoresDownloaded( LeaderboardScoresDownloaded_t *pCallback ) { for ( int i =
        ///     0; i &lt; pCallback-&gt;m_cEntryCount; i++ ) { LeaderboardEntry_t leaderboardEntry; int32
        ///     details[3]; // We know that we store this many initially.
        ...
        ///     ELeaderboardUploadScoreMethod eLeaderboardUploadScoreMethod, int32 nScore, const int32
        ///     *pScoreDetails, int cScoreDetailsCount );
        /// </code>
        /// 
        /// <br />
        /// Uploads a user score to a specified leaderboard.<br />
        /// <br />
        /// Details are optional game-defined information which outlines how the user got that score. For
        /// example if it's a racing style time based leaderboard you could store the timestamps when the player
        /// hits each checkpoint. If you have collectibles along the way you could use bit fields as booleans to
        /// store the items the player picked up in the playthrough.<br />
        /// <br />
        /// Uploading scores to Steam is rate limited to 10 uploads per 10 minutes and you may only have one
        /// outstanding call to this function at a time.<br />
        /// <br />
        /// <b>Returns:</b>
        /// <a href="https://partner.steamgames.com/doc/api/steam_api#SteamAPICall_t" class="bb_apilink">SteamAPICall_t</a>
        /// to be used with a
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#LeaderboardScoreUploaded_t" class="bb_apilink">LeaderboardScoreUploaded_t</a>
        /// call result.<br />
        /// <br />
        /// <br />
        /// <b>See Also:</b>
        ...
        /// attached handle will be available when the entry is retrieved and can be accessed by other users
        /// using
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#GetDownloadedLeaderboardEntry" class="bb_apilink">ISteamUserStats::GetDownloadedLeaderboardEntry</a>
        /// which contains <code class="bb_code bb_code_inline nohighlight">LeaderboardEntry_t.m_hUGC</code>. To
        /// create and download user generated content see the documentation for the Steam Workshop.<br />
        /// <br />
        ...
        /// <summary>
        /// <code>SteamAPICall_t GetNumberOfCurrentPlayers();</code>
        /// Asynchronously retrieves the total number of players currently playing the current game. Both online
        /// and in offline mode.<br />
        /// <br />
        /// <b>Returns:</b>
        /// <a href="https://partner.steamgames.com/doc/api/steam_api#SteamAPICall_t" class="bb_apilink">SteamAPICall_t</a>
        /// to be used with a
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#NumberOfCurrentPlayers_t" class="bb_apilink">NumberOfCurrentPlayers_t</a>
        /// call result.
        /// </summary>
        /// 
        public static SteamAPICall GetNumberOfCurrentPlayers() => Instance.GetNumberOfCurrentPlayers();
        /// <summary>
        /// <code>SteamAPICall_t RequestGlobalAchievementPercentages();</code>
        /// Asynchronously fetch the data for the percentage of players who have received each achievement for
        /// the current game globally.<br />
        /// <br />
        /// You must have called
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#RequestCurrentStats" class="bb_apilink">ISteamUserStats::RequestCurrentStats</a>
        /// and it needs to return successfully via its callback prior to calling this!<br />
        ...
        /// <a href="https://partner.steamgames.com/doc/api/steam_api#SteamAPICall_t" class="bb_apilink">SteamAPICall_t</a>
        /// to be used with a
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#GlobalAchievementPercentagesReady_t" class="bb_apilink">GlobalAchievementPercentagesReady_t</a>
        /// call result.<br />
        /// <br />
        /// <br />
        /// <b>See Also:</b>
        ...
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#GetNextMostAchievedAchievementInfo" class="bb_apilink">ISteamUserStats::GetNextMostAchievedAchievementInfo</a>,
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#GetAchievementAchievedPercent" class="bb_apilink">ISteamUserStats::GetAchievementAchievedPercent</a>
        /// </summary>
        /// 
        ...
        /// <summary>
        /// <code>
        ///     int GetMostAchievedAchievementInfo( char *pchName, uint32 unNameBufLen, float *pflPercent, bool
        ///     *pbAchieved );
        /// </code>
        /// 
        /// <br />
        ...
        /// Returns <b>-1</b> if
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#RequestGlobalAchievementPercentages" class="bb_apilink">ISteamUserStats::RequestGlobalAchievementPercentages</a>
        /// has not been called or if there are no global achievement percentages for this app Id.<br />
        /// <br />
        /// If the call is successful it returns an iterator which should be used with
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#GetNextMostAchievedAchievementInfo" class="bb_apilink">ISteamUserStats::GetNextMostAchievedAchievementInfo</a>.<br />
        /// <br />
        /// <b>See Also:</b>
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#RequestCurrentStats" class="bb_apilink">ISteamUserStats::RequestCurrentStats</a>,
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#RequestGlobalAchievementPercentages" class="bb_apilink">ISteamUserStats::RequestGlobalAchievementPercentages</a>,
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#GetNextMostAchievedAchievementInfo" class="bb_apilink">ISteamUserStats::GetNextMostAchievedAchievementInfo</a>,
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#GetAchievementAchievedPercent" class="bb_apilink">ISteamUserStats::GetAchievementAchievedPercent</a><br />
        /// <br />
        /// <b>Example:</b><br />
        /// <code>
        ///     const int ACH_NAME_MAX_LENGTH = 64; char[ACH_NAME_MAX_LENGTH] achName; float achPercent; float
        ///     achUnlocked; int i = SteamUserStats()-&gt;GetMostAchievedAchievementInfo( achName,
        ///     ACH_NAME_MAX_LENGTH, achPercent, achUnlocked ); while ( i != -1 ) { printf( "AchievementInfo -
        ///     name: %s, percent: %f, unlocked: %d", achName, achPercent, achUnlocked ); // Do something like
        ///     add/update this info in your local achievement object or display it to the user. i =
        ///     SteamUserStats()-&gt;GetNextMostAchievedAchievementInfo( i, achName, ACH_NAME_MAX_LENGTH,
        ///     achPercent, achUnlocked ); }
        /// </code>
        /// </summary>
        ...
        ///             'API Name'.
        ///         </param>
        /// <param name="pflPercent">float *: 
        ///             Variable to return the percentage of people that have unlocked this achievement from 0
        ///             to 100.
        ///         </param>
        ...
        /// <summary>
        /// <code>
        ///     int GetNextMostAchievedAchievementInfo( int iIteratorPrevious, char *pchName, uint32
        ///     unNameBufLen, float *pflPercent, bool *pbAchieved );
        /// </code>
        /// 
        /// <br />
        ...
        /// has not been called or if there are no global achievement percentages for this app Id.<br />
        /// <br />
        /// If the call is successful it returns an iterator which should be used with subsequent calls to this
        /// function.<br />
        /// <br />
        /// <b>Example:</b><br />
        /// <code>
        ...
        /// </code>
        /// </summary>
        /// <param name="iIteratorPrevious">int: 
        ///             Iterator returned from the previous call to this function or from
        ///             <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#GetMostAchievedAchievementInfo" class="bb_apilink">ISteamUserStats::GetMostAchievedAchievementInfo</a>
        ///         </param>
        /// <param name="pchName">char *: String buffer to return the 'API Name' of the achievement into.</param>
        /// <param name="unNameBufLen">uint32: 
        ...
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// Returns <b>true</b> upon success; otherwise <b>false</b> if
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#RequestGlobalAchievementPercentages" class="bb_apilink">ISteamUserStats::RequestGlobalAchievementPercentages</a>
        /// has not been called or if the specified 'API Name' does not exist in the global achievement
        /// percentages.<br />
        /// <br />
        /// <b>See Also:</b>
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#GetMostAchievedAchievementInfo" class="bb_apilink">ISteamUserStats::GetMostAchievedAchievementInfo</a>,
        ...
        /// <summary>
        /// <code>SteamAPICall_t RequestGlobalStats( int nHistoryDays );</code>
        /// 
        /// <br />
        /// Asynchronously fetches global stats data, which is available for stats marked as "aggregated" in the
        /// App Admin panel of the Steamworks website.<br />
        /// <br />
        /// You must have called
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#RequestCurrentStats" class="bb_apilink">ISteamUserStats::RequestCurrentStats</a>
        /// and it needs to return successfully via its callback prior to calling this.<br />
        ...
        /// <a href="https://partner.steamgames.com/doc/api/steam_api#SteamAPICall_t" class="bb_apilink">SteamAPICall_t</a>
        /// to be used with a
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#GlobalStatsReceived_t" class="bb_apilink">GlobalStatsReceived_t</a>
        /// call result.<br />
        /// <br />
        /// <br />
        /// <b>See Also:</b>
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#GetGlobalStat" class="bb_apilink">ISteamUserStats::GetGlobalStat</a>,
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#GetGlobalStatHistory" class="bb_apilink">ISteamUserStats::GetGlobalStatHistory</a>
        /// </summary>
        /// <param name="nHistoryDays">int: 
        ///             How many days of day-by-day history to retrieve in addition to the overall totals. The
        ///             limit is 60.
        ///         </param>
        public static SteamAPICall RequestGlobalStats(int nHistoryDays) => Instance.RequestGlobalStats(nHistoryDays);
        /// <summary>
        /// <code>
        ///     bool GetGlobalStat( const char *pchStatName, int64 *pData ); bool GetGlobalStat( const char
        ///     *pchStatName, double *pData );
        /// </code>
        /// 
        /// <br />
        ...
        ///         has completed and successfully returned its callback.<br />
        ///     </li>
        ///     <li>The type matches the type listed in the App Admin panel of the Steamworks website.</li>
        /// </ul>
        /// <br />
        /// <b>See Also:</b>
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#GetGlobalStatHistory" class="bb_apilink">ISteamUserStats::GetGlobalStatHistory</a>
        /// </summary>
        /// <param name="pchStatName">const char *: 
        ///             The 'API Name' of the stat. Must not be longer than
        ///             <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#k_cchStatNameMax" class="bb_apilink">k_cchStatNameMax</a>.
        ///         </param>
        ...
        /// <summary>
        /// <code>
        ///     int32 GetGlobalStatHistory( const char *pchStatName, int64 *pData, uint32 cubData ); int32
        ///     GetGlobalStatHistory( const char *pchStatName, double *pData, uint32 cubData );
        /// </code>
        /// 
        /// <br />
        ...
        /// So when called, pData[0] will be today, pData[1] will be yesterday, and pData[2] will be two days
        /// ago, etc.<br />
        /// <br />
        /// You must have called
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#RequestGlobalStats" class="bb_apilink">ISteamUserStats::RequestGlobalStats</a>
        ...
        /// <br />
        /// <b>Returns:</b>
        /// <a href="https://partner.steamgames.com/doc/api/steam_api#int32" class="bb_apilink">int32</a><br />
        /// The number of elements returned in the
        /// <code class="bb_code bb_code_inline nohighlight">pData</code> array.<br />
        /// <br />
        /// A value of <b>0</b> indicates failure for one of the following reasons:<br />
        /// <ul class="bb_ul">
        ///     <li>
        ///         The specified stat does not exist in App Admin on the Steamworks website, or the changes
        ///         aren't published.<br />
        ///     </li>
        ///     <li>
        ///         <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#RequestGlobalStats" class="bb_apilink">ISteamUserStats::RequestGlobalStats</a>
        ///         has not been called or returned its callback, with at least 1 day of history.<br />
        ///     </li>
        ///     <li>
        ///         The type does not match the type listed in the App Admin panel of the Steamworks website.<br />
        ///     </li>
        ///     <li>There is no history available.</li>
        /// </ul>
        /// <br />
        /// <b>See Also:</b>
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#GetGlobalStat" class="bb_apilink">ISteamUserStats::GetGlobalStat</a>
