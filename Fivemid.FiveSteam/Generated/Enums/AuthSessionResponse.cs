...
{
    /// <summary>Callback return values for the <a href="https://partner.steamgames.com/doc/api/ISteamUser#ValidateAuthTicketResponse_t" class="bb_apilink">ValidateAuthTicketResponse_t</a> callback which is posted as a response to <a href="https://partner.steamgames.com/doc/api/ISteamUser#BeginAuthSession" class="bb_apilink">ISteamUser::BeginAuthSession</a> and <a href="https://partner.steamgames.com/doc/api/ISteamGameServer#BeginAuthSession" class="bb_apilink">ISteamGameServer::BeginAuthSession</a>.<br />
    /// <br />
    /// </summary>
    public enum AuthSessionResponse : int
    {
        /// <summary>Steam has verified the user is online, the ticket is valid and ticket has not been reused.</summary>
        OK = 0,
        ...
        VACBanned = 3,
        /// <summary>The user account has logged in elsewhere and the session containing the game instance has been disconnected.</summary>
        LoggedInElseWhere = 4,
