...
{
    /// <summary>Flags for enumerating friends list, or quickly checking the relationship between users.<br />
    /// <br />
    /// </summary>
    public enum FriendFlags : int
    {
        ...
        /// <summary>Users that are on the same game server; as set by <a href="https://partner.steamgames.com/doc/api/ISteamFriends#SetPlayedWith" class="bb_apilink">ISteamFriends::SetPlayedWith</a>.</summary>
        ...
        /// <summary>Users that are currently sending additional info about themselves after a call to <a href="https://partner.steamgames.com/doc/api/ISteamFriends#RequestUserInformation" class="bb_apilink">ISteamFriends::RequestUserInformation</a></summary>
        ...
        /// <summary>Users that have ignored the current user; but the current user still knows about them.</summary>
