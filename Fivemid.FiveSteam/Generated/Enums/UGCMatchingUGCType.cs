...
{
    /// <summary>Specifies the types of UGC to obtain from a call to <a href="https://partner.steamgames.com/doc/api/ISteamUGC#CreateQueryUserUGCRequest" class="bb_apilink">ISteamUGC::CreateQueryUserUGCRequest</a> or <a href="https://partner.steamgames.com/doc/api/ISteamUGC#CreateQueryAllUGCRequest" class="bb_apilink">ISteamUGC::CreateQueryAllUGCRequest</a>.<br />
    /// <br />
    /// </summary>
    public enum UGCMatchingUGCType : int
    {
        ...
        Items = 0,
        /// <summary>Microtransaction items. (See: <a href="https://partner.steamgames.com/doc/features/workshop#curated_workshop" class="bb_doclink">Curated Workshop</a>)</summary>
        Items_Mtx = 1,
        /// <summary>Regular in game items that players have uploaded. (See: <a href="https://partner.steamgames.com/doc/features/workshop#ready-to-use_workshop" class="bb_doclink">Ready-To-Use Workshop</a>)</summary>
        Items_ReadyToUse = 2,
