...
namespace Fivemid.FiveSteam
{
    ...
    /// to specify the sorting and filtering for queries across all available UGC.<br />
    /// <br />
    /// 
    /// </summary>
    public enum UGCQuery : int
    {
        ...
        /// <summary>
        ///             Sort by vote popularity within the given "trend" period (set in
        ...
        /// <summary>
        ///             Filter to items created by users that the current user has followed, sorted by
        ...
        NotYetRated = 8,
        /// <summary>
        ///             Sort by total # of votes ascending (used internally for building the user's voting
        ///             queue)
        ///         </summary>
        RankedByTotalVotesAsc = 9,
        /// <summary>
        ///             Sort by number of votes up descending. Will use the "trend" period if specified (set in
        ///             <a href="https://partner.steamgames.com/doc/api/ISteamUGC#SetRankedByTrendDays" class="bb_apilink">ISteamUGC::SetRankedByTrendDays</a>)
        ///         </summary>
        RankedByVotesUp = 10,
        ...
        /// <summary>
        ///             Sort by average playtime in the "trend" period descending (set in
        ///             <a href="https://partner.steamgames.com/doc/api/ISteamUGC#SetRankedByTrendDays" class="bb_apilink">ISteamUGC::SetRankedByTrendDays</a>)
        ///         </summary>
