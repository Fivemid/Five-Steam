...
{
    /// <summary>Enumerates high level connection states.<br />
    /// <br />
    /// </summary>
    public enum SteamNetworkingConnectionState : int
    {
        /// <summary>Dummy value used to indicate an error condition in the API.
        /// Specified connection doesn't exist or has already been closed.</summary>
        None = 0,
        /// <summary>We are trying to establish whether peers can talk to each other,
        ...
        /// remote host, which ordinarily happens when a connection is closed.)</summary>
        Connecting = 1,
        /// <summary>Some connection types use a back channel or trusted 3rd party
        /// for earliest communication.  If the server accepts the connection,
        /// then these connections switch into the rendezvous state.  During this
        /// state, we still have not yet established an end-to-end route (through
        /// the relay network), and so if you send any messages unreliable, they
        /// are going to be discarded.</summary>
        FindingRoute = 2,
        /// <summary>We've received communications from our peer (and we know
        /// who they are) and are all good.  If you close the connection now,
        /// we will make our best effort to flush out any reliable sent data that
        /// has not been acknowledged by the peer.  (But note that this happens
        /// from within the application process, so unlike a TCP connection, you are
        /// not totally handing it off to the operating system to deal with it.)</summary>
        Connected = 3,
        /// <summary>Connection has been closed by our peer, but not closed locally.
        /// The connection still exists from an API perspective.  You must close the
        /// handle to free up resources.  If there are any messages in the inbound queue,
        /// you may retrieve them.  Otherwise, nothing may be done with the connection
        /// except to close it.
        /// 
        /// This stats is similar to CLOSE_WAIT in the TCP state machine.</summary>
        ClosedByPeer = 4,
        /// <summary>A disruption in the connection has been detected locally.  (E.g. timeout,
        ...
        /// in the queue are available.</summary>
        ProblemDetectedLocally = 5,
        /// <summary>We've disconnected on our side, and from an API perspective the connection is closed.
        ...
        /// it appear as if something is wrong).</summary>
        FinWait = -1,
        /// <summary>We've disconnected on our side, and from an API perspective the connection is closed.
        ...
        /// before sending any more data.</summary>
        Linger = -2,
        /// <summary>Connection is completely inactive and ready to be destroyed</summary>
        Dead = -3,
        /// <summary></summary>
