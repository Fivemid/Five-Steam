...
{
    /// <summary>Describes which notification timer has expired, for steam china duration control feature. Some of these notifications are deprecated and are no longer sent.<br />
    /// <br />
    /// <br />
    ...
    public enum DurationControlNotification : int
    {
        ...
        None = 0,
        /// <summary>player has been playing for an hour - game can show something at this time if desired</summary>
        _1Hour = 1,
        ...
        /// <summary>player has been playing for the allowed time and should exit the game</summary>
        ExitSoon_5h = 6,
        /// <summary>player has been playing until the locally allowed time of day (10PM) and should exit the game</summary>
        ExitSoon_Night = 7
    }
}