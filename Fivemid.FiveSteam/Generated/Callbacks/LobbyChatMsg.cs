...
namespace Fivemid.FiveSteam
{
    ...
    /// <a href="https://partner.steamgames.com/doc/api/ISteamMatchmaking#GetLobbyChatEntry" class="bb_apilink">ISteamMatchmaking::GetLobbyChatEntry</a>
    /// to retrieve the contents of this message.<br />
    /// <br />
    /// 
    /// <br />
    ...
    public unsafe struct LobbyChatMsg : global::Unity.Entities.IComponentData
    {
        ...
        /// <summary>
        ///             Type of message received. This is actually a
        ...
        /// <summary>
        ///             The index of the chat entry to use with
        ///             <a href="https://partner.steamgames.com/doc/api/ISteamMatchmaking#GetLobbyChatEntry" class="bb_apilink">ISteamMatchmaking::GetLobbyChatEntry</a>, this is not valid outside of the scope of this callback and should never be stored.
        ///         </summary>
        public uint iChatID;
    }
}