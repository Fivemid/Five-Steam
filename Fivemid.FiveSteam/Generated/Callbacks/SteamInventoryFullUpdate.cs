...
{
    /// <summary>
    /// Triggered when GetAllItems successfully returns a result which is newer / fresher than the last
    /// known result. (It will not trigger if the inventory hasn't changed, or if results from two
    /// overlapping calls are reversed in flight and the earlier result is already known to be
    /// stale/out-of-date.)<br />
    /// The regular
    ...
    /// callback will still be triggered immediately afterwards; this is an additional notification for your
    /// convenience.<br />
    /// <br />
    /// 
    /// </summary>
