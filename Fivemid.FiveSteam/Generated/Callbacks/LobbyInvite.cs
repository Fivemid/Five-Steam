...
{
    /// <summary>
    /// Someone has invited you to join a Lobby. Normally you don't need to do anything with this, as the
    /// Steam UI will also display a '&lt;user&gt; has invited you to the lobby, join?' notification and
    /// message.<br />
    /// <br />
    /// If the user outside a game chooses to join, your game will be launched with the parameter
    /// <code class="bb_code bb_code_inline nohighlight">+connect_lobby &lt;64-bit lobby id&gt;</code>, or
    /// with the callback
