...
{
    /// <summary>
    /// A client has been approved to connect to this game server.<br />
    /// <br />
    /// 
    /// </summary>
    public unsafe struct GSClientApprove : global::Unity.Entities.IComponentData
    {
        ...
        /// <summary>
        ///             The Steam ID that owns the game, this will be different from
        ///             <code class="bb_code bb_code_inline nohighlight">m_SteamID</code> if the game is
        ///             accessed via Steam Family Sharing.
        ///         </summary>
