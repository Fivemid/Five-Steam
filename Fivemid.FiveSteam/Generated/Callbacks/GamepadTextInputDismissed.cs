...
{
    /// <summary>
    /// Called when the big picture gamepad text input has been closed.<br />
    /// <br />
    /// 
    /// </summary>
    public unsafe struct GamepadTextInputDismissed : global::Unity.Entities.IComponentData
    {
        ...
        /// <summary>
        ///             <b>true</b> if user entered &amp; accepted text (Call
        ...
        ///             to receive the text), <b>false</b> if input was canceled.
        ///         </summary>
