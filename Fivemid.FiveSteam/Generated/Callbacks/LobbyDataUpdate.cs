...
{
    /// <summary>
    /// The lobby metadata has changed.<br />
    /// <br />
    /// If <code class="bb_code bb_code_inline nohighlight">m_ulSteamIDMember</code> is a user in the lobby,
    /// then use
    ...
    /// to access per-user details; otherwise, if
    /// <code class="bb_code bb_code_inline nohighlight">m_ulSteamIDMember</code> ==
    /// <code class="bb_code bb_code_inline nohighlight">m_ulSteamIDLobby</code>, use
    /// <a href="https://partner.steamgames.com/doc/api/ISteamMatchmaking#GetLobbyData" class="bb_apilink">ISteamMatchmaking::GetLobbyData</a>
    /// to access the lobby metadata.<br />
    /// <br />
    /// 
    /// <br />
    ...
    public unsafe struct LobbyDataUpdate : global::Unity.Entities.IComponentData
    {
        ...
        /// <summary>
        ///             <b>true</b> if the lobby data was successfully changed, otherwise
        ///             <b>false</b>.
        ///         </summary>
