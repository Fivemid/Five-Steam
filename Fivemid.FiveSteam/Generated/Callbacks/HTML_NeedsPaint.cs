...
{
    /// <summary>
    /// Called when a browser surface has a pending paint. This is where you get the actual image data to
    /// render to the screen.<br />
    /// <br />
    /// 
    /// </summary>
    public unsafe struct HTML_NeedsPaint : global::Unity.Entities.IComponentData
    {
        ...
        /// <summary>
        ///             A pointer to the B8G8R8A8 image data for this surface, valid until
        ///             <a href="https://partner.steamgames.com/doc/api/steam_api#SteamAPI_RunCallbacks" class="bb_apilink">SteamAPI_RunCallbacks</a>
        ///             is next called.
        ///         </summary>
        public UTF8StringPtr pBGRA;
        /// <summary>
        ///             The total width of the
        ///             <code class="bb_code bb_code_inline nohighlight">pBGRA</code> texture.
        ///         </summary>
        public uint unWide;
        /// <summary>
        ...
        /// <summary>
        ///             Incremented on each new page load, you can use this to reject draws while navigating to
        ///             new pages.
        ///         </summary>
