...
{
    /// <summary>
    /// Result when finding a leaderboard.<br />
    /// <br />
    /// 
    /// <br />
    ...
    public unsafe struct LeaderboardFindResult : global::Unity.Entities.IComponentData
    {
        ...
        /// <summary>
        ///             Handle to the leaderboard that was searched for. <b>0</b> if no leaderboard
        ///             was found.
        ///         </summary>
        public SteamLeaderboard hSteamLeaderboard;
        /// <summary>
        ///             Was the leaderboard found? <b>1</b> if it was, <b>0</b> if it
        ///             wasn't.
        ///         </summary>
