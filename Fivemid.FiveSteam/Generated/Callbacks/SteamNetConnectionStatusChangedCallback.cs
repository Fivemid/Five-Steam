...
namespace Fivemid.FiveSteam
{
    ...
    ///         <a href="https://partner.steamgames.com/doc/api/ISteamNetworkingSockets#AcceptConnection" class="bb_apilink">ISteamNetworkingSockets::AcceptConnection</a>.<br />
    ///     </li>
    ///     <li>
    ...
    ///         <a href="https://partner.steamgames.com/doc/api/ISteamNetworkingSockets#CloseConnection" class="bb_apilink">ISteamNetworkingSockets::CloseConnection</a>
    ...
    ///     </li>
    ///     <li>
    ///         <strong>A problem was detected with the connection, and it has been closed by the local
    ///             host.</strong>
    ...
    public unsafe struct SteamNetConnectionStatusChangedCallback : global::Unity.Entities.IComponentData
    {
        ...
        /// missing documentation for SteamNetConnectionStatusChangedCallback_t.m_hConn
        public HSteamNetConnection hConn;
        /// missing documentation for SteamNetConnectionStatusChangedCallback_t.m_info
        public SteamNetConnectionInfo info;
        /// missing documentation for SteamNetConnectionStatusChangedCallback_t.m_eOldState
