...
{
    /// <summary>Callback returned <a href="https://partner.steamgames.com/doc/api/ISteamUGC#GetWorkshopEULAStatus" class="bb_apilink">ISteamUGC::GetWorkshopEULAStatus</a><br />
    /// <br />
    /// <br />
    /// <b>Associated Functions:</b> <a href="https://partner.steamgames.com/doc/api/ISteamUGC#GetWorkshopEULAStatus" class="bb_apilink">ISteamUGC::GetWorkshopEULAStatus</a></summary>
    public unsafe struct WorkshopEULAStatus : global::Unity.Entities.IComponentData
    {
        ...
        /// <summary>True if the user accepted the given version, false otherwise.  Note that this can be true if the user accepted an older version of the EULA.</summary>
