...
{
    /// <summary>
    /// Called when the latest stats and achievements for a specific user (including the local user) have
    /// been received from the server.<br />
    /// <br />
    /// 
    /// <br />
    ...
    public unsafe struct UserStatsReceived : global::Unity.Entities.IComponentData
    {
        ...
        /// <summary>
        ///             Returns whether the call was successful or not. If the user has no stats, this will be
        ///             set to
