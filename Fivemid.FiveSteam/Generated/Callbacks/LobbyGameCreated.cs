...
namespace Fivemid.FiveSteam
{
    ...
    /// for all of the members of the lobby to join. It's up to the individual clients to take action on
    /// this; the typical game behavior is to leave the lobby and connect to the specified game server; but
    /// the lobby may stay open throughout the session if desired.<br />
    /// <br />
    /// 
    /// <br />
    ...
    public unsafe struct LobbyGameCreated : global::Unity.Entities.IComponentData
    {
        ...
        /// <summary>
        ///             The IP address of the game server in host order, i.e 127.0.0.1 == 0x7f000001, if it's
        ///             set.
        ///         </summary>
        public uint unIP;
