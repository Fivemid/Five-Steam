...
namespace Fivemid.FiveSteam
{
    ...
    /// <code class="bb_code bb_code_inline nohighlight">&lt;input type="file"&gt;</code> click or similar,
    /// you must call
    /// <a href="https://partner.steamgames.com/doc/api/ISteamHTMLSurface#FileLoadDialogResponse" class="bb_apilink">ISteamHTMLSurface::FileLoadDialogResponse</a>
    /// with the file(s) the user selected.<br />
    /// <br />
    /// 
    /// </summary>
    public unsafe struct HTML_FileOpenDialog : global::Unity.Entities.IComponentData
    {
        ...
        /// <summary>
        ///             The filename that the page wants you to set by default. It may be expecting a file with
        ///             that name or that was the file the user previously uploaded.
        ///         </summary>
