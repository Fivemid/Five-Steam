...
{
    /// <summary>
    /// Called when Rich Presence data has been updated for a user, this can happen automatically when
    /// friends in the same game update their rich presence, or after a call to
    /// <a href="https://partner.steamgames.com/doc/api/ISteamFriends#RequestFriendRichPresence" class="bb_apilink">ISteamFriends::RequestFriendRichPresence</a>.<br />
    /// <br />
    /// 
    /// <br />
