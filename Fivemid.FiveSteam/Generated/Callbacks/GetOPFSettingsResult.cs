...
namespace Fivemid.FiveSteam
{
    ...
    /// <a href="https://partner.steamgames.com/doc/api/ISteamVideo#GetOPFStringForApp" class="bb_apilink">ISteamVideo::GetOPFStringForApp</a>
    /// to access the OPF details.<br />
    /// <br />
    /// 
    /// <br />
    /// <b>Associated Functions:</b>
    /// <a href="https://partner.steamgames.com/doc/api/ISteamVideo#GetOPFSettings" class="bb_apilink">ISteamVideo::GetOPFSettings</a>
    /// </summary>
    public unsafe struct GetOPFSettingsResult : global::Unity.Entities.IComponentData
    {
        ...
        ///                     - The video could not be accessed. Please ensure the account you are logged in
        ///                     with owns this video.<br />
        ///                 </li>
        ///                 <li>
        ...
        ///                     - This video is not currently available to stream.<br />
        ///                 </li>
        ///                 <li>
        ///                     <a href="https://partner.steamgames.com/doc/api/steam_api#k_EResultBlocked" class="bb_apilink">k_EResultBlocked</a>
        ///                     - Sorry, this video is not yet available to watch.
        ///                 </li>
        ///             </ul>
        ///         </summary>
