...
{
    /// <summary>Sent by the Steam server to the client telling it to disconnect from the specified game server, which it may be in the process of or already connected to.<br />
    ...
    public unsafe struct ClientGameServerDeny : global::Unity.Entities.IComponentData
    {
        ...
        public uint uAppID;
        /// <summary>The IP of the game server that is telling us to disconnect, in host order, i.e 127.0.0.1 == 0x7f000001.</summary>
        ...
        /// <summary>Is the game server VAC secure (<b>true</b>) or not (<b>false</b>)?</summary>
