...
namespace Fivemid.FiveSteam
{
    ...
    /// to any other completed state, see
    /// <a href="https://partner.steamgames.com/doc/api/ISteamInventory#GetResultStatus" class="bb_apilink">ISteamInventory::GetResultStatus</a>
    /// for the complete list of states. There will always be exactly one callback per handle.<br />
    /// <br />
    /// 
    /// </summary>
    public unsafe struct SteamInventoryResultReady : global::Unity.Entities.IComponentData
    {
        ...
        /// <summary>
        ///             The new status of the handle. This is equivalent to calling
        ///             <a href="https://partner.steamgames.com/doc/api/ISteamInventory#GetResultStatus" class="bb_apilink">ISteamInventory::GetResultStatus</a>.
        ///         </summary>
