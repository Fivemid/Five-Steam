...
{
    /// <summary>
    /// Called when the browser has been requested to close due to user interaction; usually because of a
    /// javascript <code class="bb_code bb_code_inline nohighlight">window.close()</code> call.<br />
    /// <br />
    /// 
    /// </summary>
