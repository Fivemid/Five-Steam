...
{
    /// <summary>
    /// Marks the return of a request officer list call.<br />
    /// <br />
    /// 
    /// <br />
    ...
    public unsafe struct ClanOfficerListResponse : global::Unity.Entities.IComponentData
    {
        ...
        /// <summary>
        ///             The number of officers in the group. This is the same as
        ...
        /// <summary>
        ///             Was the call successful? If it wasn't this may indicate a temporary loss of connection
        ///             to Steam.<br />
        ///             If this returns <b>true</b>, this does not necessarily mean that all of the
        ///             info for this Steam group has been downloaded.
        ///         </summary>
