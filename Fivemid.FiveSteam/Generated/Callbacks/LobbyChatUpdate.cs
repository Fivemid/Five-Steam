...
namespace Fivemid.FiveSteam
{
    ...
    public unsafe struct LobbyChatUpdate : global::Unity.Entities.IComponentData
    {
        ...
        /// <summary>Chat member who made the change. This can be different from <code class="bb_code bb_code_inline nohighlight">m_ulSteamIDUserChanged</code> if kicking, muting, etc. For example, if one user kicks another from the lobby, this will be set to the id of the user who initiated the kick.</summary>
        public ulong ulSteamIDMakingChange;
        /// <summary>Bitfield of <a href="https://partner.steamgames.com/doc/api/ISteamMatchmaking#EChatMemberStateChange" class="bb_apilink">EChatMemberStateChange</a> values.</summary>
