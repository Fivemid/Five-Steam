...
{
    /// <summary>Called when the user tries to join a lobby from their friends list or from an invite. The game client should attempt to connect to specified lobby when this is received. If the game isn't running yet then the game will be automatically launched with the command line parameter <code class="bb_code bb_code_inline nohighlight">+connect_lobby &lt;64-bit lobby Steam ID&gt;</code> instead.<br />
    /// <br />
    /// <br />
