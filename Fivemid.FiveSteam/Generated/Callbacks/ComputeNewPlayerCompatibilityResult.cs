...
{
    /// <summary>
    /// Sent when the game server is checking if the new player is a good fit for the server based on the
    /// frenemy system.<br />
    /// <br />
    /// 
    /// <br />
    /// <b>Associated Functions:</b>
    /// <a href="https://partner.steamgames.com/doc/api/ISteamGameServer#ComputeNewPlayerCompatibility" class="bb_apilink">ISteamGameServer::ComputeNewPlayerCompatibility</a>
    /// </summary>
    public unsafe struct ComputeNewPlayerCompatibilityResult : global::Unity.Entities.IComponentData
    {
        ...
        /// <summary>
        ///             The number of players on the server that the specified player doesn't like playing with.
        ///         </summary>
        public int cPlayersThatCandidateDoesntLike;
        /// <summary>
        ///             The number of players in the associated Steam group that don't like playing with the
        ///             player.
        ///         </summary>
