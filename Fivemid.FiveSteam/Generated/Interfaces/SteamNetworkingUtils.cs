...
namespace Fivemid.FiveSteam
{
    public unsafe static class SteamNetworkingUtils
    {
        ...
        /// <summary>
        /// <code>SteamNetworkingMessage_t *AllocateMessage( int cbAllocateBuffer )</code>
        /// Allocate and initialize a message object. Usually the reason you call this is to pass it to
        /// <a href="https://partner.steamgames.com/doc/api/ISteamNetworkingSockets#SendMessages" class="bb_apilink">ISteamNetworkingSockets::SendMessages</a>. The returned object will have all of the relevant fields cleared to zero.<br />
        /// <br />
        ...
        /// <summary>
        /// <code>void InitRelayNetworkAccess();</code>
        ...
        /// <a href="https://partner.steamgames.com/doc/api/ISteamNetworkingUtils#GetRelayNetworkStatus" class="bb_apilink">ISteamNetworkingUtils::GetRelayNetworkStatus</a>
        /// or listen for
        /// <a href="https://partner.steamgames.com/doc/api/steamnetworkingtypes#SteamRelayNetworkStatus_t%20" class="bb_apilink">SteamRelayNetworkStatus_t
        /// </a>
        ...
        /// <br />
        /// <a href="https://partner.steamgames.com/doc/api/steamnetworkingtypes#SteamRelayNetworkStatus_t" class="bb_apilink">SteamRelayNetworkStatus_t</a>
        /// is also a callback. It will be triggered on both the user and gameserver interfaces any time the
        /// status changes, or ping measurement starts or stops.<br />
        /// <br />
        ...
        /// <summary>
        /// <code>float GetLocalPingLocation( SteamNetworkPingLocation_t &amp;result );</code>
        /// <br />
        ...
        /// calling
        /// <a href="https://partner.steamgames.com/doc/api/ISteamNetworkingUtils#InitializeRelayNetworkAccess" class="bb_apilink">ISteamNetworkingUtils::InitializeRelayNetworkAccess</a>, the data may not be available yet.<br />
        /// <br />
        ...
        /// coordinator" library. See
        /// <a href="https://partner.steamgames.com/doc/api/steamdatagramrelay" class="bb_apilink">steamdatagramrelay</a>
        /// for more info on how to obtain the game coordinator SDK.
        /// </summary>
        /// 
        ...
        /// <summary>
        /// <code>bool CheckPingDataUpToDate( float flMaxAgeSeconds );</code>
        ...
        /// <summary>
        /// <code>int GetDirectPingToPOP( SteamNetworkingPOPID popID );</code>
        ...
        /// <summary>
        /// <code>int GetPOPCount();</code>
        /// Get number of network points of presence in the config
        /// </summary>
        /// 
        public static int GetPOPCount() => Instance.GetPOPCount();
        /// <summary>
        /// <code>int GetPOPList( SteamNetworkingPOPID *list, int nListSz );</code>
        ...
        /// <summary>
        /// <code>SteamNetworkingMicroseconds GetLocalTimestamp();</code>
        /// <br />
        ...
        /// <br />
        /// <b>IMPORTANT</b>: This may be called from a service thread, while we own a mutex, etc.
        ...
        /// <summary>
        /// <code>bool IsFakeIPv4( uint32 nIPv4 );</code>
        /// <br />
