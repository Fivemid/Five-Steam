...
{
    /// <summary>
    /// Provides the core of the Steam Game Servers API.</summary>
    public unsafe interface ISteamGameServer
    {
        ...
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamGameServer_SetProduct", CallingConvention = Platform.CC)]
        internal static extern void SetProduct(void* self, UTF8StringPtr pszProduct);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamGameServer_SetGameDescription", CallingConvention = Platform.CC)]
        internal static extern void SetGameDescription(void* self, UTF8StringPtr pszGameDescription);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamGameServer_SetModDir", CallingConvention = Platform.CC)]
        internal static extern void SetModDir(void* self, UTF8StringPtr pszModDir);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamGameServer_SetDedicatedServer", CallingConvention = Platform.CC)]
        internal static extern void SetDedicatedServer(void* self, bool bDedicated);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamGameServer_LogOn", CallingConvention = Platform.CC)]
        internal static extern void LogOn(void* self, UTF8StringPtr pszToken);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamGameServer_LogOnAnonymous", CallingConvention = Platform.CC)]
        internal static extern void LogOnAnonymous(void* self);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamGameServer_LogOff", CallingConvention = Platform.CC)]
        internal static extern void LogOff(void* self);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamGameServer_BLoggedOn", CallingConvention = Platform.CC)]
        internal static extern bool BLoggedOn(void* self);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamGameServer_BSecure", CallingConvention = Platform.CC)]
        internal static extern bool BSecure(void* self);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamGameServer_GetSteamID", CallingConvention = Platform.CC)]
        internal static extern SteamId GetSteamID(void* self);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamGameServer_WasRestartRequested", CallingConvention = Platform.CC)]
        internal static extern bool WasRestartRequested(void* self);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamGameServer_SetMaxPlayerCount", CallingConvention = Platform.CC)]
        internal static extern void SetMaxPlayerCount(void* self, int cPlayersMax);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamGameServer_SetBotPlayerCount", CallingConvention = Platform.CC)]
        internal static extern void SetBotPlayerCount(void* self, int cBotplayers);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamGameServer_SetServerName", CallingConvention = Platform.CC)]
        internal static extern void SetServerName(void* self, UTF8StringPtr pszServerName);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamGameServer_SetMapName", CallingConvention = Platform.CC)]
        internal static extern void SetMapName(void* self, UTF8StringPtr pszMapName);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamGameServer_SetPasswordProtected", CallingConvention = Platform.CC)]
        internal static extern void SetPasswordProtected(void* self, bool bPasswordProtected);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamGameServer_SetSpectatorPort", CallingConvention = Platform.CC)]
        internal static extern void SetSpectatorPort(void* self, ushort unSpectatorPort);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamGameServer_SetSpectatorServerName", CallingConvention = Platform.CC)]
        internal static extern void SetSpectatorServerName(void* self, UTF8StringPtr pszSpectatorServerName);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamGameServer_ClearAllKeyValues", CallingConvention = Platform.CC)]
        internal static extern void ClearAllKeyValues(void* self);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamGameServer_SetKeyValue", CallingConvention = Platform.CC)]
        internal static extern void SetKeyValue(void* self, UTF8StringPtr pKey, UTF8StringPtr pValue);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamGameServer_SetGameTags", CallingConvention = Platform.CC)]
        internal static extern void SetGameTags(void* self, UTF8StringPtr pchGameTags);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamGameServer_SetGameData", CallingConvention = Platform.CC)]
        internal static extern void SetGameData(void* self, UTF8StringPtr pchGameData);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamGameServer_SetRegion", CallingConvention = Platform.CC)]
        internal static extern void SetRegion(void* self, UTF8StringPtr pszRegion);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamGameServer_SetAdvertiseServerActive", CallingConvention = Platform.CC)]
        internal static extern void SetAdvertiseServerActive(void* self, bool bActive);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamGameServer_GetAuthSessionTicket", CallingConvention = Platform.CC)]
        ...
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamGameServer_BeginAuthSession", CallingConvention = Platform.CC)]
        ...
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamGameServer_EndAuthSession", CallingConvention = Platform.CC)]
        internal static extern void EndAuthSession(void* self, SteamId steamID);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamGameServer_CancelAuthTicket", CallingConvention = Platform.CC)]
        internal static extern void CancelAuthTicket(void* self, HAuthTicket hAuthTicket);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamGameServer_UserHasLicenseForApp", CallingConvention = Platform.CC)]
        internal static extern UserHasLicenseForAppResult UserHasLicenseForApp(void* self, SteamId steamID, AppId appID);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamGameServer_RequestUserGroupStatus", CallingConvention = Platform.CC)]
        internal static extern bool RequestUserGroupStatus(void* self, SteamId steamIDUser, SteamId steamIDGroup);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamGameServer_GetGameplayStats", CallingConvention = Platform.CC)]
        internal static extern void GetGameplayStats(void* self);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamGameServer_GetServerReputation", CallingConvention = Platform.CC)]
        internal static extern SteamAPICall GetServerReputation(void* self);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamGameServer_GetPublicIP", CallingConvention = Platform.CC)]
        internal static extern SteamIPAddress GetPublicIP(void* self);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamGameServer_HandleIncomingPacket", CallingConvention = Platform.CC)]
        internal static extern bool HandleIncomingPacket(void* self, void* pData, int cbData, uint srcIP, ushort srcPort);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamGameServer_GetNextOutgoingPacket", CallingConvention = Platform.CC)]
        internal static extern int GetNextOutgoingPacket(void* self, void* pOut, int cbMaxOut, uint* pNetAdr, ushort* pPort);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamGameServer_AssociateWithClan", CallingConvention = Platform.CC)]
        internal static extern SteamAPICall AssociateWithClan(void* self, SteamId steamIDClan);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamGameServer_ComputeNewPlayerCompatibility", CallingConvention = Platform.CC)]
        internal static extern SteamAPICall ComputeNewPlayerCompatibility(void* self, SteamId steamIDNewPlayer);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamGameServer_SendUserConnectAndAuthenticate_DEPRECATED", CallingConvention = Platform.CC)]
        ...
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamGameServer_CreateUnauthenticatedUserConnection", CallingConvention = Platform.CC)]
        internal static extern SteamId CreateUnauthenticatedUserConnection(void* self);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamGameServer_SendUserDisconnect_DEPRECATED", CallingConvention = Platform.CC)]
