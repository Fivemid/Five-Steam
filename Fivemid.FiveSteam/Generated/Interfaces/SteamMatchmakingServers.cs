...
namespace Fivemid.FiveSteam
{
    public unsafe static class SteamMatchmakingServers
    {
        ...
        /// <summary>
        /// <code>
        ///     HServerListRequest RequestInternetServerList( AppId_t iApp, MatchMakingKeyValuePair_t
        ...
        /// <br />
        /// <b>Returns:</b>
        /// <a href="https://partner.steamgames.com/doc/api/ISteamMatchmaking#HServerListRequest" class="bb_apilink">HServerListRequest</a><br />
        /// Triggers a
        ...
        /// <br />
        /// <b>NOTE:</b> This request object must be released by calling
        ...
        /// <summary>
        /// <code>
        ///     HServerListRequest RequestLANServerList( AppId_t iApp, ISteamMatchmakingServerListResponse
        ...
        /// <summary>
        /// <code>
        ///     HServerListRequest RequestFriendsServerList( AppId_t iApp, MatchMakingKeyValuePair_t
        ///     **ppchFilters, uint32 nFilters, ISteamMatchmakingServerListResponse *pRequestServersResponse );
        /// </code>
        /// 
        /// <br />
        ...
        /// <summary>
        /// <code>
        ///     HServerListRequest RequestFavoritesServerList( AppId_t iApp, MatchMakingKeyValuePair_t
        ///     **ppchFilters, uint32 nFilters, ISteamMatchmakingServerListResponse *pRequestServersResponse );
        /// </code>
        /// 
        /// <br />
        ...
        /// <summary>
        /// <code>
        ///     HServerListRequest RequestHistoryServerList( AppId_t iApp, MatchMakingKeyValuePair_t
        ///     **ppchFilters, uint32 nFilters, ISteamMatchmakingServerListResponse *pRequestServersResponse );
        /// </code>
        /// 
        /// <br />
        ...
        /// <summary>
        /// <code>
        ///     HServerListRequest RequestSpectatorServerList( AppId_t iApp, MatchMakingKeyValuePair_t
        ///     **ppchFilters, uint32 nFilters, ISteamMatchmakingServerListResponse *pRequestServersResponse );
        /// </code>
        /// 
        /// <br />
        ...
        /// <summary>
        /// <code>void ReleaseRequest( HServerListRequest hServerListRequest );</code>
        /// 
        /// <br />
        /// Releases the asynchronous server list request object and cancels any pending query on it if there's
        /// a pending query in progress.<br />
        /// <br />
        ...
        /// <a href="https://partner.steamgames.com/doc/api/ISteamMatchmakingServers#GetServerCount" class="bb_apilink">ISteamMatchmakingServers::GetServerCount</a>.<br />
        /// <br />
        /// You will also receive index values in
        /// <code class="bb_code bb_code_inline nohighlight">ISteamMatchmakingServerListResponse::ServerResponded</code>
        /// callbacks.<br />
        /// <br />
        ...
        /// <summary>
        /// <code>void CancelQuery( HServerListRequest hRequest );</code>
        /// 
        /// <br />
        ...
        /// may have been passed<br />
        /// to one of the below request calls. Not doing so may result in a crash when a callback occurs on the
        /// destructed object.<br />
        /// Canceling a query does not release the allocated request handle. The request handle must be released
        /// using
        /// <a href="https://partner.steamgames.com/doc/api/ISteamMatchmakingServers#ReleaseRequest" class="bb_apilink">ISteamMatchmakingServers::ReleaseRequest</a>.
        /// </summary>
        /// <param name="hRequest">HServerListRequest: The handle to the server list request.</param>
        ...
        /// <br />
        /// The query callback installed when the server list was requested will be used again to post
        /// notifications and <code class="bb_code bb_code_inline nohighlight">RefreshComplete</code> will be
        ...
        /// <a href="https://partner.steamgames.com/doc/api/ISteamMatchmakingServers#GetServerDetails" class="bb_apilink">ISteamMatchmakingServers::GetServerDetails</a>.<br />
        /// <br />
        /// <b>Returns:</b> int<br />
        ...
        /// <summary>
        /// <code>
        ///     HServerQuery PingServer( uint32 unIP, uint16 usPort, ISteamMatchmakingPingResponse
        ///     *pRequestServersResponse );
        /// </code>
        /// 
        /// <br />
        /// Queries an individual game servers directly via IP/Port to request an updated ping time and other
        /// details from the server.<br />
        /// <br />
        /// You must inherit from the
        /// <code class="bb_code bb_code_inline nohighlight">ISteamMatchmakingPingResponse</code> object to
        /// receive this callback.
        /// <h4>ISteamMatchmakingPingResponse</h4>
        /// Callback interface for receiving responses after pinging an individual server.<br />
        /// <br />
        /// If you are destructing an object that implements this interface then you should call
        /// <a href="https://partner.steamgames.com/doc/api/ISteamMatchmakingServers#CancelServerQuery" class="bb_apilink">ISteamMatchmakingServers::CancelServerQuery</a>
        /// passing in the handle to the query which is in progress. Failure to cancel in progress queries when
        /// destructing a callback handler may result in a crash when a callback later occurs.<br />
        /// <br />
        ...
        /// <summary>
        /// <code>
        ///     HServerQuery PlayerDetails( uint32 unIP, uint16 usPort, ISteamMatchmakingPlayersResponse
        ///     *pRequestServersResponse );
        /// </code>
        /// 
        /// <br />
        /// Queries an individual game servers directly via IP/Port to request the list of players currently
        /// playing on the server.<br />
        /// <br />
        /// You must inherit from the
        /// <code class="bb_code bb_code_inline nohighlight">ISteamMatchmakingPlayersResponse</code> object to
        /// receive this callback.
        /// <h4>ISteamMatchmakingPlayersResponse</h4>
        /// Callback interface for receiving responses after pinging an individual server.<br />
        /// <br />
        /// If you are destructing an object that implements this interface then you should call
        /// <a href="https://partner.steamgames.com/doc/api/ISteamMatchmakingServers#CancelServerQuery" class="bb_apilink">ISteamMatchmakingServers::CancelServerQuery</a>
        ...
        /// <summary>
        /// <code>
        ///     HServerQuery ServerRules( uint32 unIP, uint16 usPort, ISteamMatchmakingRulesResponse
        ///     *pRequestServersResponse );
        /// </code>
        /// 
        /// <br />
        /// Queries an individual game servers directly via IP/Port to request the list of rules that the server
        /// is running. (See
        /// <a href="https://partner.steamgames.com/doc/api/ISteamGameServer#SetKeyValue" class="bb_apilink">ISteamGameServer::SetKeyValue</a>
        /// to set the rules on the server side.)<br />
        /// <br />
        /// You must inherit from the
        /// <code class="bb_code bb_code_inline nohighlight">ISteamMatchmakingRulesResponse</code> object to
        /// receive this callback.
        /// <h4>ISteamMatchmakingRulesResponse</h4>
        /// Callback interface for receiving responses after pinging an individual server.<br />
        /// <br />
        /// If you are destructing an object that implements this interface then you should call
        /// <a href="https://partner.steamgames.com/doc/api/ISteamMatchmakingServers#CancelServerQuery" class="bb_apilink">ISteamMatchmakingServers::CancelServerQuery</a>
        ...
        /// <ul class="bb_ul">
        ///     <li>
        ///         <a href="https://partner.steamgames.com/doc/api/ISteamMatchmakingServers#PingServer" class="bb_apilink">ISteamMatchmakingServers::PingServer</a><br />
        ///     </li>
        ///     <li>
        ///         <a href="https://partner.steamgames.com/doc/api/ISteamMatchmakingServers#PlayerDetails" class="bb_apilink">ISteamMatchmakingServers::PlayerDetails</a><br />
        ///     </li>
        ///     <li>
