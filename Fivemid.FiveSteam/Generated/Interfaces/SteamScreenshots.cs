...
namespace Fivemid.FiveSteam
{
    public unsafe static class SteamScreenshots
    {
        ...
        /// <br />
        /// <b>Returns:</b>
        /// <a href="https://partner.steamgames.com/doc/api/ISteamScreenshots#ScreenshotHandle" class="bb_apilink">ScreenshotHandle</a><br />
        /// Triggers a
        ...
        /// apply tags.<br />
        /// Returns
        /// <a href="https://partner.steamgames.com/doc/api/ISteamScreenshots#INVALID_SCREENSHOT_HANDLE" class="bb_apilink">INVALID_SCREENSHOT_HANDLE</a>
        /// if the file could not be saved.<br />
        /// <br />
        ...
        /// <param name="pchThumbnailFilename">const char *: 
        ///             The absolute file path to an optional thumbnail image. This must be 200px wide, as
        ///             described by
        ///             <a href="https://partner.steamgames.com/doc/api/ISteamScreenshots#k_ScreenshotThumbWidth" class="bb_apilink">k_ScreenshotThumbWidth</a>
        ///             and the same aspect ratio. Pass <b>NULL</b> if there is no thumbnail, one will
        ...
        /// <summary>
        /// <code>void TriggerScreenshot();</code>
        ...
        /// <a href="https://partner.steamgames.com/doc/api/ISteamScreenshots#IsScreenshotsHooked" class="bb_apilink">ISteamScreenshots::IsScreenshotsHooked</a>.<br />
        /// <br />
        /// <b>Returns:</b> void<br />
        /// Triggers a
        /// <a href="https://partner.steamgames.com/doc/api/ISteamScreenshots#ScreenshotRequested_t" class="bb_apilink">ScreenshotRequested_t</a>
        /// callback.<br />
        /// Triggers a
        /// <a href="https://partner.steamgames.com/doc/api/ISteamScreenshots#ScreenshotReady_t" class="bb_apilink">ScreenshotReady_t</a>
        /// callback.<br />
        ...
        /// <a href="https://partner.steamgames.com/doc/api/ISteamScreenshots#HookScreenshots" class="bb_apilink">ISteamScreenshots::HookScreenshots</a>. Otherwise
        /// <a href="https://partner.steamgames.com/doc/api/ISteamScreenshots#ScreenshotReady_t" class="bb_apilink">ScreenshotReady_t</a>
        ...
        /// <summary>
        /// <code>void HookScreenshots( bool bHook );</code>
        /// 
        /// <br />
        ...
        /// <a href="https://partner.steamgames.com/doc/api/ISteamScreenshots#TriggerScreenshot" class="bb_apilink">ISteamScreenshots::TriggerScreenshot</a>
        /// is called, and then the game is expected to call
        /// <a href="https://partner.steamgames.com/doc/api/ISteamScreenshots#WriteScreenshot" class="bb_apilink">ISteamScreenshots::WriteScreenshot</a>
        /// or
        /// <a href="https://partner.steamgames.com/doc/api/ISteamScreenshots#AddScreenshotToLibrary" class="bb_apilink">ISteamScreenshots::AddScreenshotToLibrary</a>
        /// in response.<br />
        /// <br />
        /// You can check if hooking is enabled with
        /// <a href="https://partner.steamgames.com/doc/api/ISteamScreenshots#IsScreenshotsHooked" class="bb_apilink">ISteamScreenshots::IsScreenshotsHooked</a>.
        /// </summary>
        ...
        /// <a href="https://partner.steamgames.com/doc/api/ISteamScreenshots#WriteScreenshot" class="bb_apilink">ISteamScreenshots::WriteScreenshot</a>,
        /// <a href="https://partner.steamgames.com/doc/api/ISteamScreenshots#AddScreenshotToLibrary" class="bb_apilink">ISteamScreenshots::AddScreenshotToLibrary</a>,
        /// <a href="https://partner.steamgames.com/doc/api/ISteamScreenshots#AddVRScreenshotToLibrary" class="bb_apilink">ISteamScreenshots::AddVRScreenshotToLibrary</a>
        /// calls.<br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// <b>true</b> if the location was successfully added to the screenshot.<br />
        /// <b>false</b> if <code class="bb_code bb_code_inline nohighlight">hScreenshot</code> was
        ...
        /// <summary>
        /// <code>bool TagUser( ScreenshotHandle hScreenshot, CSteamID steamID );</code>
        /// 
        /// <br />
        /// Tags a Steam user as being visible in the screenshot.<br />
        /// <br />
        /// You can tag up to the value declared by
        /// <a href="https://partner.steamgames.com/doc/api/ISteamScreenshots#k_nScreenshotMaxTaggedUsers" class="bb_apilink">k_nScreenshotMaxTaggedUsers</a>
        /// in a single screenshot. Tagging more users than that will just be discarded.<br />
        /// <br />
        ...
        /// <br />
        /// You can tag up to the value declared by
        /// <a href="https://partner.steamgames.com/doc/api/ISteamScreenshots#k_nScreenshotMaxTaggedPublishedFiles" class="bb_apilink">k_nScreenshotMaxTaggedPublishedFiles</a>
        ...
        /// <a href="https://partner.steamgames.com/doc/api/ISteamScreenshots#HookScreenshots" class="bb_apilink">ISteamScreenshots::HookScreenshots</a>.<br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// <b>true</b> if the game is hooking screenshots and is expected to handle them; otherwise,
        /// <b>false</b>.
        /// </summary>
        /// 
        ...
        ///             library view.
        ///         </param>
        /// <param name="pchVRFilename">const char *: 
