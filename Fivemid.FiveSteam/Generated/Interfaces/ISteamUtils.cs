...
namespace Fivemid.FiveSteam
{
    ...
    public unsafe interface ISteamUtils
    {
        ...
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamUtils_GetSecondsSinceAppActive", CallingConvention = Platform.CC)]
        internal static extern uint GetSecondsSinceAppActive(void* self);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamUtils_GetSecondsSinceComputerActive", CallingConvention = Platform.CC)]
        internal static extern uint GetSecondsSinceComputerActive(void* self);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamUtils_GetConnectedUniverse", CallingConvention = Platform.CC)]
        internal static extern Universe GetConnectedUniverse(void* self);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamUtils_GetServerRealTime", CallingConvention = Platform.CC)]
        internal static extern uint GetServerRealTime(void* self);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamUtils_GetIPCountry", CallingConvention = Platform.CC)]
        internal static extern UTF8StringPtr GetIPCountry(void* self);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamUtils_GetImageSize", CallingConvention = Platform.CC)]
        internal static extern bool GetImageSize(void* self, int iImage, uint* pnWidth, uint* pnHeight);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamUtils_GetImageRGBA", CallingConvention = Platform.CC)]
        internal static extern bool GetImageRGBA(void* self, int iImage, byte* pubDest, int nDestBufferSize);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamUtils_GetCurrentBatteryPower", CallingConvention = Platform.CC)]
        internal static extern byte GetCurrentBatteryPower(void* self);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamUtils_GetAppID", CallingConvention = Platform.CC)]
        internal static extern uint GetAppID(void* self);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamUtils_SetOverlayNotificationPosition", CallingConvention = Platform.CC)]
        internal static extern void SetOverlayNotificationPosition(void* self, NotificationPosition eNotificationPosition);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamUtils_IsAPICallCompleted", CallingConvention = Platform.CC)]
        internal static extern bool IsAPICallCompleted(void* self, SteamAPICall hSteamAPICall, bool* pbFailed);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamUtils_GetAPICallFailureReason", CallingConvention = Platform.CC)]
        internal static extern SteamAPICallFailure GetAPICallFailureReason(void* self, SteamAPICall hSteamAPICall);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamUtils_GetAPICallResult", CallingConvention = Platform.CC)]
        ...
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamUtils_GetIPCCallCount", CallingConvention = Platform.CC)]
        internal static extern uint GetIPCCallCount(void* self);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamUtils_SetWarningMessageHook", CallingConvention = Platform.CC)]
        internal static extern void SetWarningMessageHook(void* self, Unknown pFunction);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamUtils_IsOverlayEnabled", CallingConvention = Platform.CC)]
        internal static extern bool IsOverlayEnabled(void* self);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamUtils_BOverlayNeedsPresent", CallingConvention = Platform.CC)]
        internal static extern bool BOverlayNeedsPresent(void* self);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamUtils_CheckFileSignature", CallingConvention = Platform.CC)]
        internal static extern SteamAPICall CheckFileSignature(void* self, UTF8StringPtr szFileName);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamUtils_ShowGamepadTextInput", CallingConvention = Platform.CC)]
        ...
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamUtils_SetOverlayNotificationInset", CallingConvention = Platform.CC)]
        internal static extern void SetOverlayNotificationInset(void* self, int nHorizontalInset, int nVerticalInset);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamUtils_IsSteamInBigPictureMode", CallingConvention = Platform.CC)]
        internal static extern bool IsSteamInBigPictureMode(void* self);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamUtils_StartVRDashboard", CallingConvention = Platform.CC)]
        internal static extern void StartVRDashboard(void* self);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamUtils_IsVRHeadsetStreamingEnabled", CallingConvention = Platform.CC)]
        internal static extern bool IsVRHeadsetStreamingEnabled(void* self);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamUtils_SetVRHeadsetStreamingEnabled", CallingConvention = Platform.CC)]
        internal static extern void SetVRHeadsetStreamingEnabled(void* self, bool bEnabled);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamUtils_IsSteamChinaLauncher", CallingConvention = Platform.CC)]
        ...
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamUtils_ShowFloatingGamepadTextInput", CallingConvention = Platform.CC)]
        ...
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamUtils_SetGameLauncherMode", CallingConvention = Platform.CC)]
        internal static extern void SetGameLauncherMode(void* self, bool bLauncherMode);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamUtils_DismissFloatingGamepadTextInput", CallingConvention = Platform.CC)]
