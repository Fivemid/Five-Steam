...
namespace Fivemid.FiveSteam
{
    public unsafe static class SteamUtils
    {
        ...
        /// <summary>
        /// <code>uint32 GetSecondsSinceAppActive();</code>
        /// Returns the number of seconds since the application was active.<br />
        /// <br />
        /// <b>Returns:</b>
        ...
        /// <summary>
        /// <code>uint32 GetSecondsSinceComputerActive();</code>
        /// Returns the number of seconds since the user last moved the mouse.<br />
        /// <br />
        /// <b>Returns:</b>
        /// <a href="https://partner.steamgames.com/doc/api/steam_api#uint32" class="bb_apilink">uint32</a>
        /// </summary>
        ...
        /// <summary>
        /// <code>EUniverse GetConnectedUniverse();</code>
        /// Gets the universe that the current client is connecting to. (Valve use only.)<br />
        /// <br />
        /// <b>Returns:</b>
        /// <a href="https://partner.steamgames.com/doc/api/steam_api#EUniverse" class="bb_apilink">EUniverse</a><br />
        /// [type]EUniverse[/type]
        /// </summary>
        /// 
        public static Universe GetConnectedUniverse() => Instance.GetConnectedUniverse();
        /// <summary>
        /// <code>uint32 GetServerRealTime();</code>
        /// Returns the Steam server time in Unix epoch format. (Number of seconds since Jan 1, 1970 UTC)<br />
        /// <br />
        /// <b>Returns:</b>
        /// <a href="https://partner.steamgames.com/doc/api/steam_api#uint32" class="bb_apilink">uint32</a>
        /// </summary>
        ...
        /// <summary>
        /// <code>const char * GetIPCountry();</code>
        /// Returns the 2 digit ISO 3166-1-alpha-2 format country code which client is running in.<br />
        /// e.g "US" or "UK".<br />
        /// <br />
        /// This is looked up via an IP-to-location database.<br />
        /// <br />
        /// <b>Returns:</b> const char *
        /// </summary>
        /// 
        public static UTF8StringPtr GetIPCountry() => Instance.GetIPCountry();
        /// <summary>
        /// <code>bool GetImageSize( int iImage, uint32 *pnWidth, uint32 *pnHeight );</code>
        /// 
        /// <br />
        ...
        /// to create an appropriately sized buffer that will be filled with the raw image data.<br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// <b>true</b> upon success if the image handle is valid and the sizes were filled out,
        ...
        /// so that you can create your buffer with an appropriate size. You can then allocate your buffer with
        /// the width and height as: width * height * 4. The image is provided in RGBA format. This call can be
        /// somewhat expensive as it converts from the compressed type (JPG, PNG, TGA) and provides no internal
        /// caching of returned buffer, thus it is highly recommended to only call this once per image handle
        /// and cache the result. This function is only used for Steam Avatars and Achievement images and those
        /// are not expected to change mid game.<br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// <b>true</b> upon success if the image handle is valid and the buffer was filled out,
        /// otherwise <b>false</b>.<br />
        /// <br />
        /// <b>See Also:</b>
        /// <a href="https://partner.steamgames.com/doc/api/ISteamFriends#GetSmallFriendAvatar" class="bb_apilink">ISteamFriends::GetSmallFriendAvatar</a>,
        /// <a href="https://partner.steamgames.com/doc/api/ISteamFriends#GetMediumFriendAvatar" class="bb_apilink">ISteamFriends::GetMediumFriendAvatar</a>,
        /// <a href="https://partner.steamgames.com/doc/api/ISteamFriends#GetLargeFriendAvatar" class="bb_apilink">ISteamFriends::GetLargeFriendAvatar</a>,
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#GetAchievementIcon" class="bb_apilink">ISteamUserStats::GetAchievementIcon</a><br />
        /// <br />
        /// <b>Example:</b><br />
        /// <code>
        ///     HGAMETEXTURE GetSteamImageAsTexture( int iImage ) { HGAMETEXTURE hTexture = 0; // You should
        ///     first check if you have already cached this image using something like a dictionary/map // with
        ///     iImage as the key and then return the texture handle associated with it if it exists. // If it
        ///     doesn't exist, continue on, and add the texture to the map before returning at the end of the
        ///     function. // If we have to check the size of the image. uint32 uAvatarWidth, uAvatarHeight; bool
        ///     success = SteamUtils()-&gt;GetImageSize( iImage, &amp;uAvatarWidth, &amp;uAvatarHeight ); if (
        ///     !success ) { // Log a warning message. return hTexture; } // Get the actual raw RGBA data from
        ///     Steam and turn it into a texture in our game engine const int uImageSizeInBytes = uAvatarWidth *
        ///     uAvatarHeight * 4; uint8 *pAvatarRGBA = new uint8[uImageSizeInBytes]; success =
        ///     SteamUtils()-&gt;GetImageRGBA( iImage, pAvatarRGBA, uImageSizeInBytes ); if( !success ) { // Do
        ///     something to convert the RGBA texture into your internal texture format for displaying. //
        ///     hTexture = m_pGameEngine-&gt;HCreateTexture( pAvatarRGBA, uAvatarWidth, uAvatarHeight ); // And
        ///     add the texture to the cache } // Don't forget to free the memory! delete[] pAvatarRGBA; return
        ///     hTexture; }
        /// </code>
        /// </summary>
        ...
        /// <summary>
        /// <code>uint8 GetCurrentBatteryPower();</code>
        /// Gets the current amount of battery power on the computer.<br />
        /// <br />
        /// <b>Returns:</b>
        /// <a href="https://partner.steamgames.com/doc/api/steam_api#uint8" class="bb_apilink">uint8</a><br />
        ...
        /// <summary>
        /// <code>uint32 GetAppID();</code>
        /// Gets the App ID of the current process.<br />
        /// <br />
        /// <b>Returns:</b>
        ...
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUtils#SetOverlayNotificationInset" class="bb_apilink">ISteamUtils::SetOverlayNotificationInset</a>.<br />
        /// <br />
        ...
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// <b>true</b> if the API Call is valid and has completed, otherwise
        /// <b>false</b>.<br />
        /// <br />
        /// <b>See Also:</b>
        ...
        /// <br />
        /// The primary usage for this function is debugging. The failure reasons are typically out of your
        /// control and tend to not be very important. Just keep retrying your API Call until it works.<br />
        /// <br />
        /// <b>Returns:</b>
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUtils#ESteamAPICallFailure" class="bb_apilink">ESteamAPICallFailure</a><br />
        ...
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUtils#GetAPICallResult" class="bb_apilink">ISteamUtils::GetAPICallResult</a><br />
        /// <br />
        /// <b>Example:</b><br />
        /// <code>
        ///     void CHTMLSurface::OnBrowserReady( HTML_BrowserReady_t *pBrowserReady, bool bIOFailure ) { if (
        ///     bIOFailure ) { SteamUtils()-&gt;GetAPICallFailureReason( handle ); // handle must be stored
        ///     separately. return; } }
        /// </code>
        /// </summary>
        ...
        /// <summary>
        /// <code>
        ///     bool GetAPICallResult( SteamAPICall_t hSteamAPICall, void *pCallback, int cubCallback, int
        ///     iCallbackExpected, bool *pbFailed );
        /// </code>
        /// 
        /// <br />
        ...
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// <b>true</b> upon success if the API Call is valid and has completed, otherwise
        /// <b>false</b>.<br />
        /// <br />
        /// If the call is successful, it copies the callback into
        /// <code class="bb_code bb_code_inline nohighlight">pCallback</code> and returns failures in
        /// <code class="bb_code bb_code_inline nohighlight">pbFailed</code>.<br />
        /// <br />
        /// <b>See Also:</b>
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUtils#IsAPICallCompleted" class="bb_apilink">ISteamUtils::IsAPICallCompleted</a>,
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUtils#GetAPICallFailureReason" class="bb_apilink">ISteamUtils::GetAPICallFailureReason</a>
        ...
        /// <summary>
        /// <code>uint32 GetIPCCallCount();</code>
        /// Returns the number of IPC calls made since the last time this function was called.<br />
        /// <br />
        /// Used for perf debugging so you can determine how many IPC (Inter-Process Communication) calls your
        /// game makes per frame<br />
        /// Every IPC call is at minimum a thread context switch if not a process one so you want to rate
        /// control how often you do them.<br />
        /// <br />
        /// <b>Returns:</b>
        /// <a href="https://partner.steamgames.com/doc/api/steam_api#uint32" class="bb_apilink">uint32</a>
        /// </summary>
        ...
        /// <summary>
        /// <code>void SetWarningMessageHook( SteamAPIWarningMessageHook_t pFunction );</code>
        /// 
        /// <br />
        /// Sets a warning message hook to receive SteamAPI warnings and info messages in a callback
        /// function.<br />
        /// <br />
        /// The function prototype must match the definition in SteamAPIWarningMessageHook_t. This includes the
        /// extern "C" linkage and __cdecl calling convention.<br />
        /// <br />
        /// 'int nSeverity' is the severity; 0 for msg, 1 for warning. If you are running in through a debugger
        /// only warnings will be sent. If you add -debug_steamapi to the command-line then informational
        /// messages will also be sent.<br />
        /// 'const char * pchDebugText' is the text of the message.<br />
        /// Callbacks will occur directly after the API function is called that generated the warning or
        /// message<br />
        /// <br />
        ...
        ///     ::OutputDebugString( pchDebugText ); if ( nSeverity &gt;= 1 ) { // place to set a breakpoint for
        ///     catching API errors int x = 3; x = x; } } void EnableWarningMessageHook() {
        ...
        /// <summary>
        /// <code>bool IsOverlayEnabled();</code>
        /// Checks if the
        /// <a href="https://partner.steamgames.com/doc/features/overlay" class="bb_doclink">Steam Overlay</a>
        /// is running &amp; the user can access it.<br />
        /// <br />
        /// The overlay process could take a few seconds to start &amp; hook the game process, so this function
        /// will initially return false while the overlay is loading.<br />
        /// <br />
        /// <b>Returns:</b> bool
        /// </summary>
        /// 
        ...
        /// <summary>
        /// <code>bool BOverlayNeedsPresent();</code>
        /// Checks if the Overlay needs a present. Only required if using event driven render updates.<br />
        /// <br />
        /// Typically this call is unneeded if your game has a constantly running frame loop that calls the D3D
        /// Present API, or OGL SwapBuffers API every frame as is the case in most games. However, if you have a
        /// game that only refreshes the screen on an event driven basis then that can break the overlay, as it
        /// uses your Present/SwapBuffers calls to drive it's internal frame loop and it may also need to
        /// Present() to the screen any time a notification happens or when the overlay is brought up over the
        /// game by a user. You can use this API to ask the overlay if it currently need a present in that case,
        /// and then you can check for this periodically (roughly 33hz is desirable) and make sure you refresh
        /// the screen with Present or SwapBuffers to allow the overlay to do its work.<br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// <b>true</b> if the overlay needs you to refresh the screen, otherwise
        /// <b>false</b>.
        /// </summary>
        /// 
        public static bool BOverlayNeedsPresent() => Instance.BOverlayNeedsPresent();
        /// <summary>
        /// <code>SteamAPICall_t CheckFileSignature( const char *szFileName );</code>
        /// 
        /// <br />
        /// Deprecated.<br />
        /// <br />
        ...
        /// to be used with a
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUtils#CheckFileSignature_t" class="bb_apilink">CheckFileSignature_t</a>
        /// call result.
        /// </summary>
        ...
        /// <summary>
        /// <code>
        ///     bool ShowGamepadTextInput( EGamepadTextInputMode eInputMode, EGamepadTextInputLineMode
        ///     eLineInputMode, const char *pchDescription, uint32 unCharMax, const char *pchExistingText );
        /// </code>
        /// 
        /// <br />
        ...
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// <b>true</b> if the big picture overlay is running; otherwise,
        /// <b>false</b>.<br />
        /// <br />
        /// <b>See Also:</b>
        ...
        /// <summary>
        /// <code>uint32 GetEnteredGamepadTextLength();</code>
        /// Gets the length of the gamepad text input from the Big Picture overlay.<br />
        /// <br />
        /// This must be called within the
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUtils#GamepadTextInputDismissed_t" class="bb_apilink">GamepadTextInputDismissed_t</a>
        /// callback, and only if
        /// <code class="bb_code bb_code_inline nohighlight">GamepadTextInputDismissed_t.m_bSubmitted</code> is
        /// true.<br />
        /// <br />
        /// <b>Returns:</b>
        /// <a href="https://partner.steamgames.com/doc/api/steam_api#uint32" class="bb_apilink">uint32</a><br />
        ...
        /// <br />
        /// <b>See Also:</b>
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUtils#ShowGamepadTextInput" class="bb_apilink">ISteamUtils::ShowGamepadTextInput</a>,
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUtils#GetEnteredGamepadTextInput" class="bb_apilink">ISteamUtils::GetEnteredGamepadTextInput</a><br />
        /// <br />
        /// <b>Example:</b><br />
        /// <code>
        ///     void OnGamepadTextInputDismissed_t( GamepadTextInputDismissed_t* pCallback ) { // The user
        ///     canceled, if ( !pCallback.m_bSubmitted ) return; // Use some max input length that we passed
        ///     into ShowGamepadTextInput, +1 for the null terminator. const uint32 MAX_INPUT_LENGTH = 64 + 1;
        ///     uint32 length = SteamUtils()-&gt;GetEnteredGamepadTextLength(); const char*
        ///     szTextInput[MAX_INPUT_LENGTH]; bool success = SteamUtils()-&gt;GetEnteredGamepadTextInput(
        ///     szTextInput, length ); if ( !success ) { // Log an error. This should only ever happen if length
        ///     is &gt; MaxInputLength return; } // Display the updated string }
        /// </code>
        /// </summary>
        /// 
        public static uint GetEnteredGamepadTextLength() => Instance.GetEnteredGamepadTextLength();
        /// <summary>
        /// <code>bool GetEnteredGamepadTextInput( char *pchText, uint32 cchText );</code>
        /// 
        /// <br />
        ...
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// <b>true</b> if there was text to receive and
        /// <code class="bb_code bb_code_inline nohighlight">cchText</code> is the same size as
        /// GamepadTextInputDismissed_t.m_unSubmittedText; otherwise, <b>false</b>.<br />
        /// <br />
        /// <b>See Also:</b>
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUtils#ShowGamepadTextInput" class="bb_apilink">ISteamUtils::ShowGamepadTextInput</a>,
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUtils#GetEnteredGamepadTextLength" class="bb_apilink">ISteamUtils::GetEnteredGamepadTextLength</a><br />
        /// <br />
        /// <b>Example:</b><br />
        /// <code>
        ///     void OnGamepadTextInputDismissed_t( GamepadTextInputDismissed_t* pCallback ) { // The user
        ///     canceled, if ( !pCallback.m_bSubmitted ) return; // Use some max input length that we passed
        ///     into ShowGamepadTextInput, +1 for the null terminator. const uint32 MAX_INPUT_LENGTH = 64 + 1;
        ///     uint32 length = SteamUtils()-&gt;GetEnteredGamepadTextLength(); char*
        ///     szTextInput[MAX_INPUT_LENGTH]; bool success = SteamUtils()-&gt;GetEnteredGamepadTextInput(
        ///     szTextInput, length ); if ( !success ) { // Log an error. This should only ever happen if length
        ///     is &gt; MaxInputLength return; } // Display the updated string }
        /// </code>
        ...
        /// <summary>
        /// <code>const char * GetSteamUILanguage();</code>
        /// Returns the language the steam client is running in.<br />
        /// <br />
        /// You probably want
        /// <a href="https://partner.steamgames.com/doc/api/ISteamApps#GetCurrentGameLanguage" class="bb_apilink">ISteamApps::GetCurrentGameLanguage</a>
        /// instead, this should only be used in very special cases.<br />
        /// <br />
        /// For a full list of languages see
        /// <a href="https://partner.steamgames.com/doc/store/localization/languages" class="bb_doclink">Supported Languages</a>.<br />
        /// <br />
        ...
        /// <b>See Also:</b>
        /// <a href="https://partner.steamgames.com/doc/api/ISteamApps#GetCurrentGameLanguage" class="bb_apilink">ISteamApps::GetCurrentGameLanguage</a>,
        /// <a href="https://partner.steamgames.com/doc/api/ISteamApps#GetAvailableGameLanguages" class="bb_apilink">ISteamApps::GetAvailableGameLanguages</a>
        /// </summary>
        /// 
        public static UTF8StringPtr GetSteamUILanguage() => Instance.GetSteamUILanguage();
        /// <summary>
        /// <code>bool IsSteamRunningInVR();</code>
        /// Checks if Steam is running in VR mode.<br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// <b>true</b> if Steam itself is running in VR mode; otherwise, <b>false</b>.
        /// </summary>
        /// 
        ...
        /// <summary>
        /// <code>bool IsSteamInBigPictureMode();</code>
        /// Checks if Steam &amp; the Steam Overlay are running in Big Picture mode.<br />
        /// <br />
        /// Games must be launched through the Steam client to enable the Big Picture overlay.<br />
        /// During development, a game can be added as a non-steam game to the developer's library to test this
        /// feature.<br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// <b>true</b> if the Big Picture overlay is available; otherwise,
        /// <b>false</b>.<br />
        /// This will always return <b>false</b> if your app is not the 'game'
        /// <a href="https://partner.steamgames.com/doc/store/application#types_of_applications" class="bb_doclink">application type</a>.
        /// </summary>
        /// 
        public static bool IsSteamInBigPictureMode() => Instance.IsSteamInBigPictureMode();
        /// <summary>
        /// <code>void StartVRDashboard();</code>
        /// Asks Steam to create and render the OpenVR dashboard.
        /// </summary>
        /// 
        public static void StartVRDashboard() => Instance.StartVRDashboard();
        /// <summary>
        /// <code>bool IsVRHeadsetStreamingEnabled();</code>
        /// Checks if the HMD view is being streamed via Steam Remote Play.<br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// <b>true</b> if VR is enabled and the HMD view is currently being streamed; otherwise,
        /// <b>false</b>.<br />
        /// <br />
        /// <b>See Also:</b>
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUtils#SetVRHeadsetStreamingEnabled" class="bb_apilink">ISteamUtils::SetVRHeadsetStreamingEnabled</a>
        /// </summary>
        /// 
        public static bool IsVRHeadsetStreamingEnabled() => Instance.IsVRHeadsetStreamingEnabled();
        /// <summary>
        /// <code>void SetVRHeadsetStreamingEnabled( bool bEnabled );</code>
        /// 
        /// <br />
        /// Set whether the HMD content will be streamed via Steam Remote Play.<br />
        /// <br />
        /// If this is enabled, then the scene in the HMD headset will be streamed, and remote input will not be
        /// allowed. Otherwise if this is disabled, then the application window will be streamed instead, and
        /// remote input will be allowed. VR games default to enabled unless "VRHeadsetStreaming" "0" is in the
        /// extended appinfo for a game.<br />
        /// <br />
        /// This is useful for games that have asymmetric multiplayer gameplay.<br />
        /// <br />
        /// <b>See Also:</b>
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUtils#IsVRHeadsetStreamingEnabled" class="bb_apilink">ISteamUtils::IsVRHeadsetStreamingEnabled</a>
        /// </summary>
        ...
        /// <summary>
        /// <code>bool IsSteamChinaLauncher();</code>
        /// Returns whether the current launcher is a Steam China launcher. You can cause the client to behave
        /// as the Steam China launcher by adding -dev -steamchina to the command line when running Steam.
        /// </summary>
        /// 
        public static bool IsSteamChinaLauncher() => Instance.IsSteamChinaLauncher();
        /// <summary>
        /// <code>bool InitFilterText();</code>
        ...
        /// <a href="https://store.steampowered.com/account/preferences#CommunityContentPreferences" target="_blank" rel="noreferrer">Steam Account preferences</a><br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// <b>true</b> if initialization succeeds, <b>false</b> if filtering is unavailable
        /// for the game's language, in which case
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUtils#FilterText" class="bb_apilink">ISteamUtils::FilterText</a>() will act as a passthrough.<br />
        /// <br />
        /// <b>See Also:</b>
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUtils#FilterText" class="bb_apilink">ISteamUtils::FilterText</a>
        /// </summary>
        /// 
        public static bool InitFilterText(uint unFilterOptions) => Instance.InitFilterText(unFilterOptions);
        /// <summary>
        /// <code>
        ///     int FilterText( ETextFilteringContext eContext, CSteamID sourceSteamID, const char
        ///     *pchInputMessage, char *pchOutFilteredText, uint32 nByteSizeOutFilteredText );
        /// </code>
        /// 
        /// Filters the provided input message and places the filtered result into pchOutFilteredText. Legally
        /// required filtering is always applied. Additional filtering may occur, based on the context and user
        /// settings.<br />
        /// <br />
        /// <b>Returns:</b> int<br />
        ...
        /// <summary>
        /// <code>bool IsSteamRunningOnSteamDeck();</code>
        /// Checks if Steam is running on a Steam Deck device.<br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// <b>true</b> if Steam itself is running on a Steam Deck device; otherwise,
        /// <b>false</b>.
        /// </summary>
        /// 
        ...
        /// <summary>
        /// <code>
        ///     bool ShowFloatingGamepadTextInput( EFloatingGamepadTextInputMode eKeyboardMode, int
        ///     nTextFieldXPosition, int nTextFieldYPosition, int nTextFieldWidth, int nTextFieldHeight );
        /// </code>
        /// 
        /// <br />
        ...
        /// position the floating keyboard in a way that doesn't cover the text field.<br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        ...
        /// 
        /// In game launchers that don't have controller support you can call this to have Steam Input translate
        /// the controller input into mouse/kb to navigate the launcher
        /// </summary>
