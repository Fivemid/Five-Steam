...
namespace Fivemid.FiveSteam
{
    public unsafe static class SteamParties
    {
        ...
        /// <summary>
        /// <code>uint32 GetNumActiveBeacons();</code>
        /// <br />
        ...
        /// <summary>
        /// <code>PartyBeaconID_t GetBeaconByIndex( uint32 unIndex );</code>
        /// 
        /// <br />
        /// Use with
        ...
        /// to iterate the active beacons visible to the current user. <b>unIndex</b> is a zero-based
        /// index, so iterate over the range [0, GetNumActiveBeacons() - 1]. The return is a
        /// <b>PartyBeaconID_t</b> that can be used with
        /// <a href="https://partner.steamgames.com/doc/api/ISteamParties#GetBeaconDetails" class="bb_apilink">ISteamParties::GetBeaconDetails</a>
        /// to get information about the beacons suitable for display to the user. <br />
        /// <br />
        /// <b>Returns:</b>
        ...
        /// API to get further details about <b>pSteamIDBeaconOwner</b>, and
        /// <a href="https://partner.steamgames.com/doc/api/ISteamParties#GetBeaconLocationData" class="bb_apilink">ISteamParties::GetBeaconLocationData</a>
        /// to get further details about <b>pLocation</b>. The <b>pchMetadata</b> contents
        /// are specific to your game, and will be whatever was set (if anything) by the game process that
        /// created the beacon.<br />
        /// <br />
        /// <b>Returns:</b> bool
        /// </summary>
        ...
        /// to be used with a
        /// <a href="https://partner.steamgames.com/doc/api/JoinParty_t" class="bb_apilink">JoinParty_t</a> call
        /// result.<br />
        /// Returns
        ...
        /// <a href="https://partner.steamgames.com/doc/api/ISteamParties#GetAvailableBeaconLocations" class="bb_apilink">ISteamParties::GetAvailableBeaconLocations</a>.<br />
        /// <br />
        /// <b>Returns:</b> bool
        /// </summary>
        ...
        /// <br />
        /// <b>See Also:</b>
        /// <a href="https://partner.steamgames.com/doc/api/ISteamParties#GetNumAvailableBeaconLocations" class="bb_apilink">ISteamParties::GetNumAvailableBeaconLocations</a><br />
        /// <br />
        /// <b>Returns:</b> bool
        /// </summary>
        ...
        /// <a href="https://partner.steamgames.com/doc/api/steam_api#SteamAPICall_t" class="bb_apilink">SteamAPICall_t</a>
        /// to be used with a
        /// <a href="https://partner.steamgames.com/doc/api/CreateBeaconCallback_t" class="bb_apilink">CreateBeaconCallback_t</a>
        /// call result.<br />
        /// Returns
        /// <a href="https://partner.steamgames.com/doc/api/steam_api#k_uAPICallInvalid" class="bb_apilink">k_uAPICallInvalid</a>
        ...
        ///         </param>
        /// <param name="pchConnectString">char *: 
        ...
        /// your game a
        /// <a href="https://partner.steamgames.com/doc/api/ReservationNotificationCallback_t" class="bb_apilink">ReservationNotificationCallback_t</a>
        ...
        /// <b>ChangeNumOpenSlots</b> with a value of 2 for unOpenSlots. That value represents the
        /// total number of <i>new</i> users that you would like Steam to send to your party.<br />
        /// <br />
        /// <b>Returns:</b>
        /// <a href="https://partner.steamgames.com/doc/api/steam_api#SteamAPICall_t" class="bb_apilink">SteamAPICall_t</a>
        /// to be used with a
        /// <a href="https://partner.steamgames.com/doc/api/ChangeNumOpenSlotsCallback_t" class="bb_apilink">ChangeNumOpenSlotsCallback_t</a>
        /// call result.<br />
        /// Returns
        /// <a href="https://partner.steamgames.com/doc/api/steam_api#k_uAPICallInvalid" class="bb_apilink">k_uAPICallInvalid</a>
        /// if the beacon ID is invalid.
        ...
        /// <b>DestroyBeacon</b> at the right time.<br />
        /// <br />
        /// <b>Returns:</b> bool
        /// </summary>
