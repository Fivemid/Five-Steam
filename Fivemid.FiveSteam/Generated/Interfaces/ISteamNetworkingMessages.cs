...
namespace Fivemid.FiveSteam
{
    ...
    /// <a href="https://partner.steamgames.com/doc/features/multiplayer/steamdatagramrelay" class="bb_doclink">Steam Datagram Relay</a>. <br />
    /// <br />
    ...
    /// to talk to dedicated servers.<br />
    /// <br />
    /// The primary purpose of this interface is to be "like UDP", so that UDP-based code can be ported
    /// easily to take advantage of relayed connections. If you find yourself needing more low level
    /// information or control, or to be able to better handle failure, then you probably need to use
    /// <a href="https://partner.steamgames.com/doc/api/ISteamNetworkingSockets" class="bb_apilink">ISteamNetworkingSockets</a>
    ...
    /// connection mode of ISteamNetworkingSockets useful.<br />
    /// (See k_ESteamNetworkingConfig_SymmetricConnect.)<br />
    /// <br />
    /// Member functions for ISteamNetworkingMessages are called through the global accessor function
