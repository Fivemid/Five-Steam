...
namespace Fivemid.FiveSteam
{
    public unsafe static class SteamHTTP
    {
        ...
        /// are supported, so this string must start with "<a href="http://%22" target="_blank" rel="noreferrer">http://"</a>
        /// or "<a href="https://%22" target="_blank" rel="noreferrer">https://"</a> and should look like
        /// <a href="http://%22http://store.steampowered.com/app/10/%22" target="_blank" rel="noreferrer">"http://store.steampowered.com/app/10/"</a>
        /// or similar. This call returns a handle that you can use to make further calls to setup and then send
        /// the HTTP request with
        /// <a href="https://partner.steamgames.com/doc/api/ISteamHTTP#SendHTTPRequest" class="bb_apilink">ISteam</a><a href="HTTP::SendHTTPRequest" target="_blank" rel="noreferrer">HTTP::SendHTTPRequest</a> or
        /// <a href="https://partner.steamgames.com/doc/api/ISteamHTTP#SendHTTPRequestAndStreamResponse" class="bb_apilink">ISteam</a><a href="HTTP::SendHTTPRequestAndStreamResponse" target="_blank" rel="noreferrer">HTTP::SendHTTPRequestAndStreamResponse</a>.<br />
        /// <br />
        /// Don't forget to free the HTTP request when you're done with it to prevent leaking memory by calling
        /// <a href="https://partner.steamgames.com/doc/api/ISteamHTTP#ReleaseHTTPRequest" class="bb_apilink">ISteam</a><a href="HTTP::ReleaseHTTPRequest" target="_blank" rel="noreferrer">HTTP::ReleaseHTTPRequest</a>!<br />
        /// <br />
        /// <b>Returns:</b>
        /// <a href="https://partner.steamgames.com/doc/api/ISteamHTTP#HTTPRequestHandle" class="bb_apilink">HTTPRequestHandle</a><br />
        /// Returns a new request handle to be used with future calls to SteamHTTP functions. Returns
        /// <a href="https://partner.steamgames.com/doc/api/ISteamHTTP#INVALID_HTTPREQUEST_HANDLE" class="bb_apilink">INVALID_HTTPREQUEST_HANDLE</a>
        ...
        /// <a href="https://partner.steamgames.com/doc/api/ISteamHTTP#HTTPRequestCompleted_t" class="bb_apilink">HTTPRequestCompleted_t</a>
        /// callback after sending the request.<br />
        /// <br />
        ...
        /// data. Use
        /// <a href="https://partner.steamgames.com/doc/api/ISteamHTTP#SetHTTPRequestAbsoluteTimeoutMS" class="bb_apilink">ISteam</a><a href="HTTP::SetHTTPRequestAbsoluteTimeoutMS" target="_blank" rel="noreferrer">HTTP::SetHTTPRequestAbsoluteTimeoutMS</a>
        ...
        /// <a href="https://en.wikipedia.org/wiki/List_of_HTTP_header_fields#Request_fields" target="_blank" rel="noreferrer">wikipedia</a>. The User-Agent field is explicitly disallowed as it gets overwritten when the request is sent.<br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        ...
        ///     </li>
        ///     <li>
        ///         The request method set in
        ///         <a href="https://partner.steamgames.com/doc/api/ISteamHTTP#CreateHTTPRequest" class="bb_apilink">ISteam</a><a href="HTTP::CreateHTTPRequest" target="_blank" rel="noreferrer">HTTP::CreateHTTPRequest</a>
        ///         is not
        ///         <a href="https://partner.steamgames.com/doc/api/ISteamHTTP#k_EHTTPMethodGET" class="bb_apilink">k_EHTTPMethodGET</a>,
        ///         <a href="https://partner.steamgames.com/doc/api/ISteamHTTP#k_EHTTPMethodHEAD" class="bb_apilink">k_EHTTPMethodHEAD</a>, or
        ///         <a href="https://partner.steamgames.com/doc/api/ISteamHTTP#k_EHTTPMethodPOST" class="bb_apilink">k_EHTTPMethodPOST</a>.<br />
        ///     </li>
        ///     <li>
        ///         If the request method is
        ///         <a href="https://partner.steamgames.com/doc/api/ISteamHTTP#k_EHTTPMethodPOST" class="bb_apilink">k_EHTTPMethodPOST</a>
        ///         and a POST body has already been set with
        ///         <a href="https://partner.steamgames.com/doc/api/ISteamHTTP#SetHTTPRequestRawPostBody" class="bb_apilink">ISteam</a><a href="HTTP::SetHTTPRequestRawPostBody" target="_blank" rel="noreferrer">HTTP::SetHTTPRequestRawPostBody</a>.
        ///     </li>
        /// </ul>
        /// </summary>
        /// <param name="hRequest">
        ...
        /// <a href="https://partner.steamgames.com/doc/api/ISteamHTTP#PrioritizeHTTPRequest" class="bb_apilink">ISteam</a><a href="HTTP::PrioritizeHTTPRequest" target="_blank" rel="noreferrer">HTTP::PrioritizeHTTPRequest</a>
        /// or
        /// <a href="https://partner.steamgames.com/doc/api/ISteamHTTP#DeferHTTPRequest" class="bb_apilink">ISteam</a><a href="HTTP::DeferHTTPRequest" target="_blank" rel="noreferrer">HTTP::DeferHTTPRequest</a> to set
        ...
        /// <a href="https://partner.steamgames.com/doc/api/ISteamHTTP#HTTPRequestHeadersReceived_t" class="bb_apilink">HTTPRequestHeadersReceived_t</a>. You can then append data to that buffer as it comes in.<br />
        /// <br />
        ...
        /// want to use
        /// <a href="https://partner.steamgames.com/doc/api/ISteamHTTP#SendHTTPRequest" class="bb_apilink">ISteam</a><a href="HTTP::SendHTTPRequest" target="_blank" rel="noreferrer">HTTP::SendHTTPRequest</a>.<br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// Triggers a
        ...
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// Returns <b>true</b> if the request has been successfully defered. Otherwise
        /// <b>false</b> if <code class="bb_code bb_code_inline nohighlight">hRequest</code> is an
        ...
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// Returns <b>true</b> if the request has been successfully prioritized. Otherwise
        /// <b>false</b> if <code class="bb_code bb_code_inline nohighlight">hRequest</code> is an
        /// invalid handle, or if the request has not been sent yet.<br />
        /// <br />
        /// <b>See Also:</b>
        ...
        /// <a href="https://partner.steamgames.com/doc/api/ISteamHTTP#HTTPRequestCompleted_t" class="bb_apilink">HTTPRequestCompleted_t</a>
        /// call result associated with this request handle. If the response header exists in the response, then
        /// you can allocate a correctly sized buffer to get the associated value with
        /// <a href="https://partner.steamgames.com/doc/api/ISteamHTTP#GetHTTPResponseHeaderValue" class="bb_apilink">ISteam</a><a href="HTTP::GetHTTPResponseHeaderValue" target="_blank" rel="noreferrer">HTTP::GetHTTPResponseHeaderValue</a>.<br />
        /// <br />
        /// Here is a list of standard response header names on
        /// <a href="https://en.wikipedia.org/wiki/List_of_HTTP_header_fields#Response_fields" target="_blank" rel="noreferrer">wikipedia</a>.<br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// Returns <b>true</b> if the header name is present in the response and
        ...
        /// Otherwise, returns <b>false</b> and sets
        /// <code class="bb_code bb_code_inline nohighlight">unResponseHeaderSize</code> to
        /// <b>0</b> under the following conditions:<br />
        /// <ul class="bb_ul">
        ///     <li><code class="bb_code bb_code_inline nohighlight">hRequest</code> was invalid.<br /></li>
        ...
        /// This must be called after the HTTP request has completed and returned the HTTP response via the
        /// <a href="https://partner.steamgames.com/doc/api/ISteamHTTP#HTTPRequestCompleted_t" class="bb_apilink">HTTPRequestCompleted_t</a>
        /// call result associated with this request handle. You should first call
        /// <a href="https://partner.steamgames.com/doc/api/ISteamHTTP#GetHTTPResponseHeaderSize" class="bb_apilink">ISteam</a><a href="HTTP::GetHTTPResponseHeaderSize" target="_blank" rel="noreferrer">HTTP::GetHTTPResponseHeaderSize</a>
        ...
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// Returns <b>true</b> upon success indicating that
        ...
        /// or
        /// <a href="https://partner.steamgames.com/doc/api/ISteamHTTP#HTTPRequestDataReceived_t" class="bb_apilink">HTTPRequestDataReceived_t</a>
        /// associated with this request handle. If this returns successfully, then you can allocate a buffer
        /// with the provided size to fill with the data obtained from
        /// <a href="https://partner.steamgames.com/doc/api/ISteamHTTP#GetHTTPResponseBodyData" class="bb_apilink">ISteam</a><a href="HTTP::GetHTTPResponseBodyData" target="_blank" rel="noreferrer">HTTP::GetHTTPResponseBodyData</a>
        /// or
        /// <a href="https://partner.steamgames.com/doc/api/ISteamHTTP#GetHTTPStreamingResponseBodyData" class="bb_apilink">ISteam</a><a href="HTTP::GetHTTPStreamingResponseBodyData" target="_blank" rel="noreferrer">HTTP::GetHTTPStreamingResponseBodyData</a>.<br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// Returns <b>true</b> upon success indicating that
        ...
        /// <a href="https://partner.steamgames.com/doc/api/ISteamHTTP#SendHTTPRequest" class="bb_apilink">ISteam</a><a href="HTTP::SendHTTPRequest" target="_blank" rel="noreferrer">HTTP::SendHTTPRequest</a>. Use
        ...
        /// <a href="https://partner.steamgames.com/doc/api/ISteamHTTP#HTTPRequestDataReceived_t" class="bb_apilink">HTTPRequestDataReceived_t</a>
        /// callback associated with this request handle. Typically you'll want to allocate a buffer associated
        /// with the request handle using the
        /// <code class="bb_code bb_code_inline nohighlight">Content-Length</code> HTTP response field to
        /// receive the total size of the data when you receive the header via
        /// <a href="https://partner.steamgames.com/doc/api/ISteamHTTP#HTTPRequestHeadersReceived_t" class="bb_apilink">HTTPRequestHeadersReceived_t</a>. You can then append data to that buffer as it comes in.<br />
        /// <br />
        /// This is only for streaming HTTP requests which were sent with
        /// <a href="https://partner.steamgames.com/doc/api/ISteamHTTP#SendHTTPRequestAndStreamResponse" class="bb_apilink">ISteam</a><a href="HTTP::SendHTTPRequestAndStreamResponse" target="_blank" rel="noreferrer">HTTP::SendHTTPRequestAndStreamResponse</a>. Use
        /// <a href="https://partner.steamgames.com/doc/api/ISteamHTTP#GetHTTPResponseBodyData" class="bb_apilink">ISteam</a><a href="HTTP::GetHTTPResponseBodyData" target="_blank" rel="noreferrer">HTTP::GetHTTPResponseBodyData</a>
        /// if you're using
        /// <a href="https://partner.steamgames.com/doc/api/ISteamHTTP#SendHTTPRequest" class="bb_apilink">ISteam</a><a href="HTTP::SendHTTPRequest" target="_blank" rel="noreferrer">HTTP::SendHTTPRequest</a>.<br />
        /// <br />
        ...
        /// <summary>
        /// <code>bool ReleaseHTTPRequest( HTTPRequestHandle hRequest );</code>
        /// 
        /// <br />
        ...
        /// <a href="https://partner.steamgames.com/doc/api/ISteamHTTP#CreateHTTPRequest" class="bb_apilink">ISteam</a><a href="HTTP::CreateHTTPRequest" target="_blank" rel="noreferrer">HTTP::CreateHTTPRequest</a>!<br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        ...
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// Returns <b>true</b> upon success if the download percentage was successfully returned.
        ...
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// Returns <b>true</b> upon success indicating that the content-type field and the body data
        /// have been set.<br />
        /// Otherwise, returns <b>false</b> under the following conditions:<br />
        /// <ul class="bb_ul">
        ///     <li><code class="bb_code bb_code_inline nohighlight">hRequest</code> was invalid.<br /></li>
        ///     <li>
        ///         The HTTP Method set in
        ///         <a href="https://partner.steamgames.com/doc/api/ISteamHTTP#CreateHTTPRequest" class="bb_apilink">ISteam</a><a href="HTTP::CreateHTTPRequest" target="_blank" rel="noreferrer">HTTP::CreateHTTPRequest</a>
        ///         is not
        ///         <a href="https://partner.steamgames.com/doc/api/ISteamHTTP#k_EHTTPMethodPOST" class="bb_apilink">k_EHTTPMethodPOST</a>,
        ///         <a href="https://partner.steamgames.com/doc/api/ISteamHTTP#k_EHTTPMethodPUT" class="bb_apilink">k_EHTTPMethodPUT</a>, or
        ///         <a href="https://partner.steamgames.com/doc/api/ISteamHTTP#k_EHTTPMethodPATCH" class="bb_apilink">k_EHTTPMethodPATCH</a>.<br />
        ///     </li>
        ///     <li>
        ///         A POST body has already been set for this request either via this function or with
        ///         <a href="https://partner.steamgames.com/doc/api/ISteamHTTP#SetHTTPRequestGetOrPostParameter" class="bb_apilink">ISteam</a><a href="HTTP::SetHTTPRequestGetOrPostParameter" target="_blank" rel="noreferrer">HTTP::SetHTTPRequestGetOrPostParameter</a>.
        ///     </li>
        /// </ul>
        /// </summary>
        /// <param name="hRequest">
        ...
        /// <b>true</b> then any response to your requests using this cookie container may add new
        /// cookies to the container which may be transmitted with future requests. Otherwise, if it's
        /// <b>false</b> then only cookies you explicitly set will be sent.<br />
        /// <br />
        /// You can associate the cookie container with a http request by using
        /// <a href="https://partner.steamgames.com/doc/api/ISteamHTTP#SetHTTPRequestCookieContainer" class="bb_apilink">ISteam</a><a href="HTTP::SetHTTPRequestCookieContainer" target="_blank" rel="noreferrer">HTTP::SetHTTPRequestCookieContainer</a>, and you can set a cookie using
        /// <a href="https://partner.steamgames.com/doc/api/ISteamHTTP#SetCookie" class="bb_apilink">ISteam</a><a href="HTTP::SetCookie" target="_blank" rel="noreferrer">HTTP::SetCookie</a>.<br />
        /// <br />
        /// Don't forget to free the container when you're done with it to prevent leaking memory by calling
        /// <a href="https://partner.steamgames.com/doc/api/ISteamHTTP#ReleaseCookieContainer" class="bb_apilink">ISteam</a><a href="HTTP::ReleaseCookieContainer" target="_blank" rel="noreferrer">HTTP::ReleaseCookieContainer</a>!<br />
        /// <br />
        /// <b>Returns:</b>
        /// <a href="https://partner.steamgames.com/doc/api/ISteamHTTP#HTTPCookieContainerHandle" class="bb_apilink">HTTPCookieContainerHandle</a><br />
        ...
        /// <a href="https://partner.steamgames.com/doc/api/ISteamHTTP#CreateCookieContainer" class="bb_apilink">ISteam</a><a href="HTTP::CreateCookieContainer" target="_blank" rel="noreferrer">HTTP::CreateCookieContainer</a>!<br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        ...
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// Returns <b>true</b> if the cookie was set successfully. Otherwise,
        ...
        /// <b>NULL</b> or an empty string resets the user agent info to the default value.<br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        ...
        /// with
        /// <a href="https://partner.steamgames.com/doc/api/ISteamHTTP#SetHTTPRequestNetworkActivityTimeout" class="bb_apilink">ISteam</a><a href="HTTP::SetHTTPRequestNetworkActivityTimeout" target="_blank" rel="noreferrer">HTTP::SetHTTPRequestNetworkActivityTimeout</a>
        ...
        /// <a href="https://partner.steamgames.com/doc/api/ISteamHTTP#HTTPRequestCompleted_t" class="bb_apilink">HTTPRequestCompleted_t</a>
        /// if <code class="bb_code bb_code_inline nohighlight">m_bRequestSuccessful</code> is
        /// <b>false</b>.<br />
        /// <br />
        /// <b>Returns:</b> bool<br />
