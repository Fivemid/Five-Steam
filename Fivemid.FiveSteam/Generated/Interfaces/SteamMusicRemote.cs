...
namespace Fivemid.FiveSteam
{
    public unsafe static class SteamMusicRemote
    {
        ...
        /// <summary><code>bool UpdateCurrentEntryText( const char *pchText );</code><br />
        /// <br />
        /// <br />
        /// <b>Returns:</b> bool</summary>
        ...
        /// <summary><code>bool UpdateCurrentEntryElapsedSeconds( int nValue );</code><br />
        /// <br />
        /// <br />
        /// <b>Returns:</b> bool</summary>
        ...
        /// <summary><code>bool UpdateCurrentEntryCoverArt( void *pvBuffer, uint32 cbBufferLength );</code><br />
        /// <br />
        /// <br />
        /// <b>Returns:</b> bool</summary>
        /// <param name="pvBuffer">void *: </param>
        ...
        /// <summary><code>bool CurrentEntryDidChange();</code><br />
        /// <br />
        /// <b>Returns:</b> bool</summary>
        /// 
        public static bool CurrentEntryDidChange() => Instance.CurrentEntryDidChange();
        /// <summary><code>bool QueueWillChange();</code>Queue<br />
        /// <br />
        /// <b>Returns:</b> bool</summary>
        /// 
        public static bool QueueWillChange() => Instance.QueueWillChange();
        /// <summary><code>bool ResetQueueEntries();</code><br />
        /// <br />
        /// <b>Returns:</b> bool</summary>
        /// 
        public static bool ResetQueueEntries() => Instance.ResetQueueEntries();
        /// <summary><code>bool SetQueueEntry( int nID, int nPosition, const char *pchEntryText );</code><br />
        /// <br />
        /// <br />
        /// <b>Returns:</b> bool</summary>
        ...
        /// <summary><code>bool SetCurrentQueueEntry( int nID );</code><br />
        /// <br />
        /// <br />
        /// <b>Returns:</b> bool</summary>
        /// <param name="nID">int: </param>
        public static bool SetCurrentQueueEntry(int nID) => Instance.SetCurrentQueueEntry(nID);
        /// <summary><code>bool QueueDidChange();</code><br />
        /// <br />
        /// <b>Returns:</b> bool</summary>
        /// 
        public static bool QueueDidChange() => Instance.QueueDidChange();
        /// <summary><code>bool PlaylistWillChange();</code>Playlist<br />
        /// <br />
        /// <b>Returns:</b> bool</summary>
        /// 
        public static bool PlaylistWillChange() => Instance.PlaylistWillChange();
        /// <summary><code>bool ResetPlaylistEntries();</code><br />
        /// <br />
        /// <b>Returns:</b> bool</summary>
        /// 
        public static bool ResetPlaylistEntries() => Instance.ResetPlaylistEntries();
        /// <summary><code>bool SetPlaylistEntry( int nID, int nPosition, const char *pchEntryText );</code><br />
        /// <br />
        /// <br />
        /// <b>Returns:</b> bool</summary>
        /// <param name="nID">int: </param>
        ...
        /// <summary><code>bool SetCurrentPlaylistEntry( int nID );</code><br />
        /// <br />
        /// <br />
        /// <b>Returns:</b> bool</summary>
        /// <param name="nID">int: </param>
        public static bool SetCurrentPlaylistEntry(int nID) => Instance.SetCurrentPlaylistEntry(nID);
        /// <summary><code>bool PlaylistDidChange();</code><br />
        /// <br />
        /// <b>Returns:</b> bool</summary>
        /// 
