...
namespace Fivemid.FiveSteam
{
    ...
    public unsafe interface ISteamRemotePlay
    {
        ...
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamRemotePlay_GetSessionCount", CallingConvention = Platform.CC)]
        internal static extern uint GetSessionCount(void* self);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamRemotePlay_GetSessionID", CallingConvention = Platform.CC)]
        internal static extern RemotePlaySessionID GetSessionID(void* self, int iSessionIndex);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamRemotePlay_GetSessionSteamID", CallingConvention = Platform.CC)]
        internal static extern SteamId GetSessionSteamID(void* self, RemotePlaySessionID unSessionID);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamRemotePlay_GetSessionClientName", CallingConvention = Platform.CC)]
        internal static extern UTF8StringPtr GetSessionClientName(void* self, RemotePlaySessionID unSessionID);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamRemotePlay_GetSessionClientFormFactor", CallingConvention = Platform.CC)]
        internal static extern SteamDeviceFormFactor GetSessionClientFormFactor(void* self, RemotePlaySessionID unSessionID);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamRemotePlay_BGetSessionClientResolution", CallingConvention = Platform.CC)]
        ...
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamRemotePlay_BStartRemotePlayTogether", CallingConvention = Platform.CC)]
        internal static extern bool BStartRemotePlayTogether(void* self, bool bShowOverlay);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamRemotePlay_BSendRemotePlayTogetherInvite", CallingConvention = Platform.CC)]
