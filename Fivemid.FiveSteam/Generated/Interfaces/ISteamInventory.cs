...
namespace Fivemid.FiveSteam
{
    ...
    /// <br />
    /// See <a href="https://partner.steamgames.com/doc/features/inventory" class="bb_doclink">Steam Inventory Service</a> for more information.</summary>
    public unsafe interface ISteamInventory
    {
        ...
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamInventory_GetResultStatus", CallingConvention = Platform.CC)]
        ...
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamInventory_DestroyResult", CallingConvention = Platform.CC)]
        internal static extern void DestroyResult(void* self, SteamInventoryResult resultHandle);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamInventory_GetAllItems", CallingConvention = Platform.CC)]
        internal static extern bool GetAllItems(void* self, SteamInventoryResult* pResultHandle);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamInventory_GetItemsByID", CallingConvention = Platform.CC)]
        ...
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamInventory_SerializeResult", CallingConvention = Platform.CC)]
        ...
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamInventory_DeserializeResult", CallingConvention = Platform.CC)]
        ...
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamInventory_GenerateItems", CallingConvention = Platform.CC)]
        ...
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamInventory_GrantPromoItems", CallingConvention = Platform.CC)]
        internal static extern bool GrantPromoItems(void* self, SteamInventoryResult* pResultHandle);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamInventory_AddPromoItem", CallingConvention = Platform.CC)]
        internal static extern bool AddPromoItem(void* self, SteamInventoryResult* pResultHandle, SteamItemDef itemDef);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamInventory_AddPromoItems", CallingConvention = Platform.CC)]
        ...
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamInventory_ConsumeItem", CallingConvention = Platform.CC)]
        ...
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamInventory_ExchangeItems", CallingConvention = Platform.CC)]
        ...
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamInventory_TransferItemQuantity", CallingConvention = Platform.CC)]
        ...
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamInventory_SendItemDropHeartbeat", CallingConvention = Platform.CC)]
        internal static extern void SendItemDropHeartbeat(void* self);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamInventory_TriggerItemDrop", CallingConvention = Platform.CC)]
        internal static extern bool TriggerItemDrop(void* self, SteamInventoryResult* pResultHandle, SteamItemDef dropListDefinition);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamInventory_TradeItems", CallingConvention = Platform.CC)]
        ...
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamInventory_LoadItemDefinitions", CallingConvention = Platform.CC)]
        ...
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamInventory_StartPurchase", CallingConvention = Platform.CC)]
        ...
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamInventory_RequestPrices", CallingConvention = Platform.CC)]
        internal static extern SteamAPICall RequestPrices(void* self);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamInventory_GetNumItemsWithPrices", CallingConvention = Platform.CC)]
        internal static extern uint GetNumItemsWithPrices(void* self);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamInventory_GetItemsWithPrices", CallingConvention = Platform.CC)]
        ...
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamInventory_GetItemPrice", CallingConvention = Platform.CC)]
        internal static extern bool GetItemPrice(void* self, SteamItemDef iDefinition, ulong* pCurrentPrice, ulong* pBasePrice);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamInventory_StartUpdateProperties", CallingConvention = Platform.CC)]
        internal static extern SteamInventoryUpdateHandle StartUpdateProperties(void* self);
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamInventory_RemoveProperty", CallingConvention = Platform.CC)]
        ...
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamInventory_SetPropertyString", CallingConvention = Platform.CC)]
        ...
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamInventory_SetPropertyBool", CallingConvention = Platform.CC)]
        ...
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamInventory_SetPropertyInt64", CallingConvention = Platform.CC)]
        ...
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamInventory_SetPropertyFloat", CallingConvention = Platform.CC)]
        ...
        [DllImport(Platform.LIBRARY_NAME, EntryPoint = "SteamAPI_ISteamInventory_SubmitUpdateProperties", CallingConvention = Platform.CC)]
