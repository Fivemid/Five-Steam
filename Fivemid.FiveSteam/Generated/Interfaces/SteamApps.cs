...
namespace Fivemid.FiveSteam
{
    public unsafe static class SteamApps
    {
        ...
        /// <summary>
        /// <code>bool BIsSubscribed();</code>
        /// Checks if the active user is subscribed to the current App ID.<br />
        /// <br />
        /// <b>NOTE:</b> This will always return <b>true</b> if you're using Steam DRM or
        /// calling
        /// <a href="https://partner.steamgames.com/doc/api/steam_api#SteamAPI_RestartAppIfNecessary" class="bb_apilink">SteamAPI_RestartAppIfNecessary</a>.<br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// <b>true</b> if the active user owns the current AppId, otherwise <b>false</b>.
        /// </summary>
        /// 
        public static bool BIsSubscribed() => Instance.BIsSubscribed();
        /// <summary>
        /// <code>bool BIsLowViolence();</code>
        /// Checks if the license owned by the user provides low violence depots.<br />
        /// <br />
        /// Low violence depots are useful for copies sold in countries that have content restrictions.<br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// <b>true</b> if the license owned by the user provides low violence depots; otherwise,
        /// <b>false</b>.<br />
        /// <br />
        /// <b>See Also:</b>
        /// <a href="https://partner.steamgames.com/doc/store/application/depots#depot_mounting_rules" class="bb_doclink">Depot Mounting Rules</a>
        /// </summary>
        /// 
        public static bool BIsLowViolence() => Instance.BIsLowViolence();
        /// <summary>
        /// <code>bool BIsCybercafe();</code>
        /// Checks whether the current App ID is for Cyber Cafes.<br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        ...
        /// <summary>
        /// <code>bool BIsVACBanned();</code>
        /// Checks if the user has a VAC ban on their account<br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// <b>true</b> if the user has a VAC ban on their account; otherwise, <b>false</b>.
        /// </summary>
        /// 
        public static bool BIsVACBanned() => Instance.BIsVACBanned();
        /// <summary>
        /// <code>const char * GetCurrentGameLanguage();</code>
        /// Gets the current language that the user has set.<br />
        /// <br />
        /// This falls back to the Steam UI language if the user hasn't explicitly picked a language for the
        /// title.<br />
        /// <br />
        ...
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUtils#GetSteamUILanguage" class="bb_apilink">ISteamUtils::GetSteamUILanguage</a>
        /// </summary>
        /// 
        public static UTF8StringPtr GetCurrentGameLanguage() => Instance.GetCurrentGameLanguage();
        /// <summary>
        /// <code>const char * GetAvailableGameLanguages();</code>
        /// Gets a comma separated list of the languages the current app supports.<br />
        /// <br />
        /// For the full list of languages that may be returned see
        /// <a href="https://partner.steamgames.com/doc/store/localization" class="bb_doclink">Localization and Languages</a>.<br />
        /// <br />
        /// <b>Returns:</b> const char *<br />
        ...
        /// <summary>
        /// <code>bool BIsSubscribedApp( AppId_t appID );</code>
        /// 
        /// <br />
        /// Checks if the active user is subscribed to a specified AppId.<br />
        /// <br />
        /// Only use this if you need to check ownership of another game related to yours, a demo for
        /// example.<br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        ...
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// <b>true</b> if the user owns the DLC and it's currently installed, otherwise
        /// <b>false</b>.<br />
        /// <br />
        ...
        /// <a href="http://steamcommunity.com/groups/steamworks/discussions" target="_blank" rel="noreferrer">Steamworks Discussion Board</a>
        /// to properly package and secure your free weekend.<br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// <b>true</b> if the active user is subscribed to the current App Id via a free weekend
        /// otherwise <b>false</b> any other type of license.
        /// </summary>
        /// 
        public static bool BIsSubscribedFromFreeWeekend() => Instance.BIsSubscribedFromFreeWeekend();
        /// <summary>
        /// <code>int GetDLCCount();</code>
        /// Gets the number of DLC pieces for the current app.<br />
        /// <br />
        /// This is typically used to loop through each piece of DLC and get the info about each one with
        /// <a href="https://partner.steamgames.com/doc/api/ISteamApps#BGetDLCDataByIndex" class="bb_apilink">ISteamApps::BGetDLCDataByIndex</a>.<br />
        /// <br />
        /// <b>Returns:</b> int<br />
        /// The number of DLC pieces for the current app. Note that this value may max out at 64, depending on
        /// how much unowned DLC the user has. If your app has a large number of DLC, you should set your own
        /// internal list of known DLC to check against.<br />
        /// <br />
        /// <b>Example:</b><br />
        /// <code>
        ///     int32 DLCCount = SteamApps()-&gt;GetDLCCount(); for ( int i = 0; i &lt; DLCCount; ++i ) {
        ///     AppId_t appId; bool available; char name[128]; bool success =
        ///     SteamApps()-&gt;BGetDLCDataByIndex( i, &amp;appId, &amp;available, name, 128 ); if ( success ) {
        ...
        /// <summary>
        /// <code>
        ///     bool BGetDLCDataByIndex( int iDLC, AppId_t *pAppID, bool *pbAvailable, char *pchName, int
        ///     cchNameBufferSize );
        /// </code>
        /// 
        /// <br />
        ...
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// <b>true</b> if the current App ID has DLC's associated with it and
        /// <code class="bb_code bb_code_inline nohighlight">iDLC</code> falls between the range of 0 to
        /// <a href="https://partner.steamgames.com/doc/api/ISteamApps#GetDLCCount" class="bb_apilink">ISteamApps::GetDLCCount</a>, otherwise <b>false</b>.<br />
        /// <br />
        /// <b>Example:</b><br />
        /// <code>
        ///     int32 DLCCount = SteamApps()-&gt;GetDLCCount(); for ( int i = 0; i &lt; DLCCount; ++i ) {
        ...
        /// <param name="cchNameBufferSize">int: 
        ///             The length of the
        ///             <code class="bb_code bb_code_inline nohighlight">pchName</code> buffer.
        ///         </param>
        ...
        /// <summary>
        /// <code>void InstallDLC( AppId_t nAppID );</code>
        /// 
        /// <br />
        ...
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// <b>true</b> if the user is on a beta branch; otherwise, <b>false</b>.
        /// </summary>
        ...
        /// <summary>
        /// <code>bool MarkContentCorrupt( bool bMissingFilesOnly );</code>
        /// 
        /// <br />
        /// Allows you to force verify game content on next launch.<br />
        /// <br />
        /// If you detect the game is out-of-date (for example, by having the client detect a version mismatch
        /// with a server),<br />
        ...
        /// <br />
        /// This works even if the application is not installed, based on where the game would be installed with
        /// the default Steam library location.<br />
        /// <br />
        /// <b>Returns:</b>
        /// <a href="https://partner.steamgames.com/doc/api/steam_api#uint32" class="bb_apilink">uint32</a><br />
        ...
        /// <summary>
        /// <code>bool BIsAppInstalled( AppId_t appID );</code>
        /// 
        /// <br />
        /// Checks if a specific app is installed.<br />
        /// <br />
        /// The app may not actually be owned by the current user, they may have it left over from a free
        /// weekend, etc.<br />
        /// <br />
        /// This only works for base applications, not
        /// <a href="https://partner.steamgames.com/doc/store/application/dlc" class="bb_doclink">Downloadable Content (DLC)</a>. Use
        /// <a href="https://partner.steamgames.com/doc/api/ISteamApps#BIsDlcInstalled" class="bb_apilink">ISteamApps::BIsDlcInstalled</a>
        /// for DLC instead.<br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        ...
        /// Gets the Steam ID of the true owner of the current app. This is different from the current user if
        /// they are accessing this app via Family Sharing<br />
        /// <br />
        /// <b>Returns:</b>
        ...
        /// <summary>
        /// <code>const char * GetLaunchQueryParam( const char *pchKey );</code>
        /// 
        /// <br />
        /// Gets the associated launch parameter if the game is run via
        /// steam://run/&lt;appid&gt;/?param1=value1;param2=value2;param3=value3 etc.<br />
        /// <br />
        /// Parameter names starting with the character '@' are reserved for internal use and will always return
        /// an empty string.<br />
        /// Parameter names starting with an underscore '_' are reserved for steam features -- they can be
        /// queried by the game, but it is advised that you not param names beginning with an underscore for
        /// your own features.<br />
        /// <br />
        /// <b>Returns:</b> const char *<br />
        /// The value associated with the key provided. Returns an empty string ("") if the specified key does
        /// not exist.<br />
        /// <br />
        /// <b>See Also:</b>
        /// <a href="https://partner.steamgames.com/doc/api/ISteamApps#NewLaunchQueryParameters_t" class="bb_apilink">ISteamApps::NewLaunchQueryParameters_t</a>
        /// </summary>
        ...
        /// Gets the buildid of this app, may change at any time based on backend updates to the game.<br />
        /// <br />
        /// <b>Returns:</b> int<br />
        ...
        /// <summary>
        /// <code>void RequestAllProofOfPurchaseKeys();</code>
        /// Deprecated.
        /// </summary>
        /// 
        public static void RequestAllProofOfPurchaseKeys() => Instance.RequestAllProofOfPurchaseKeys();
        /// <summary>
        /// <code>SteamAPICall_t GetFileDetails( const char*pszFileName );</code>
        /// 
        /// <br />
        ...
        /// to be used with a
        /// <a href="https://partner.steamgames.com/doc/api/ISteamApps#FileDetailsResult_t" class="bb_apilink">FileDetailsResult_t</a>
        /// call result.
        /// </summary>
        ...
        /// <summary>
        /// <code>int GetLaunchCommandLine( char *pszCommandLine, int cubCommandLine );</code>
        /// 
        /// <br />
        /// Gets the command line if the game was launched via Steam URL, e.g.
        /// steam://run/&lt;appid&gt;//&lt;command line&gt;/. This method is preferable to launching with a
        /// command line via the operating system, which can be a security risk. In order for rich presence
        /// joins to go through this and not be placed on the OS command line, you must enable "Use launch
        /// command line" from the Installation &gt; General page on your app.<br />
        /// <br />
        /// <b>Returns:</b> int<br />
        /// Returns the command line as a string into the buffer provided in pszCommandLine and returns the
        /// number of bytes that were copied into that buffer.<br />
        /// <br />
        /// <b>See Also:</b>
        ...
        /// <summary>
        /// <code>bool BIsSubscribedFromFamilySharing();</code>
        /// <br />
        /// Checks if the active user is accessing the current appID via a temporary Family Shared license owned
        /// by another user. <br />
        /// <br />
        /// If you need to determine the steamID of the permanent owner of the license, use
        /// <a href="https://partner.steamgames.com/doc/api/ISteamApps#GetAppOwner" class="bb_doclink">GetAppOwner</a>.<br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// <b>true</b> if the active user is accessing the current appID via family sharing,
        /// otherwise <b>false</b>.
        /// </summary>
        /// 
        ...
        /// 
        /// <br />
        /// Checks if the user is subscribed to the current appID through a timed trial. If so, returns true and
        /// gives back the total time the timed trial is allowed to play, along with the current amount of time
        /// the user has played.<br />
        /// <br />
        /// <b>Returns:</b> bool<br />
        /// <b>true</b> if the active user is subscribed to the current appID via a timed trial
        /// otherwise <b>false</b> any other type of license.<br />
        /// <br />
        /// <b>See Also:</b>
